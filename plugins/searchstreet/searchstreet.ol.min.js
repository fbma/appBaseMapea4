...
return d},"es6-impl","es3");var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};goog.exportPath_=function(a,b,c){a=a.split(".");c=c||goog.global;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&goog.isDef(b)?c[d]=b:c=c[d]?c[d]:c[d]={}};
...
(function(){M.plugin.Searchstreet=function(a){a=a||{};this.name="searchstreet";this.panel_=this.autocompletador_=this.control_=this.map_=null;this.url_=M.config.SEARCHSTREET_URL;this.locality_="";M.utils.isNullOrEmpty(a.locality)||(this.locality_=a.locality);M.Plugin.call(this)};goog.inherits(M.plugin.Searchstreet,M.Plugin);M.plugin.Searchstreet.prototype.addTo=function(a){var b=this;this.map_=a;goog.dom.classlist.add(a._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");a=M.utils.addParameters(M.config.SEARCHSTREET_URLCOMPROBARINE,
{codigo:this.locality_});M.remote.get(a).then(function(a){var c;try{M.utils.isNullOrEmpty(a.text)||(c=JSON.parse(a.text),!M.utils.isNullOrEmpty(b.locality_)&&M.utils.isNullOrEmpty(c.comprobarCodIneResponse.comprobarCodIneReturn)&&(M.dialog.error("El c\u00f3digo del municipio '"+b.locality_+"' no es v\u00e1lido"),b.locality_="")),b.control_=new M.control.Searchstreet(b.url_,b.locality_),b.control_.on(M.evt.ADDED_TO_MAP,function(){b.fire(M.evt.ADDED_TO_MAP);b.autocompletador_=new M.plugin.Autocomplete({locality:b.locality_,
target:b.control_.getInput(),html:b.control_.getHtml()});b.map_.addPlugin(b.autocompletador_)},this),b.panel_=new M.ui.Panel("searchstreet",{collapsible:!0,className:"m-searchstreet",position:M.ui.position.TL,tooltip:"Buscador de calles"}),b.panel_.on(M.evt.ADDED_TO_MAP,function(a){b.panel_._buttonPanel.addEventListener("click",function(a){b.panel_._collapsed||b.control_.input_.focus()})}),b.panel_.addControls(b.control_),b.map_.addPanels(b.panel_)}catch(e){M.exception("La respuesta no es un JSON v\u00e1lido: "+
e)}})};M.plugin.Searchstreet.prototype.destroy=function(){this.map_.removeControls([this.control_]);this.autocompletador_.destroy();this.locality_=this.url_=this.panel_=this.autocompletador_=this.control_=this.map_=this.name=null};M.plugin.Searchstreet.prototype.equals=function(a){return a instanceof M.plugin.Searchstreet?!0:!1}})();P.control={};P.control.Searchstreet={};
...
function(){goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.removePoints_();this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_.getImpl().removePopup();this.element_=this.listPoints=this.facadeMap_=null};M.impl.control.Searchstreet.POPUP_TEMPLATE="searchstreetpopup.html"})();goog.exportSymbol("M.impl.control.Searchstreet",M.impl.control.Searchstreet);goog.exportProperty(M.impl.control.Searchstreet.prototype,"listPoints",M.impl.control.Searchstreet.prototype.listPoints);goog.exportProperty(M.impl.control.Searchstreet.prototype,"addTo",M.impl.control.Searchstreet.prototype.addTo);goog.exportProperty(M.impl.control.Searchstreet.prototype,"drawPoints",M.impl.control.Searchstreet.prototype.drawPoints);
goog.exportProperty(M.impl.control.Searchstreet.prototype,"zoomResults",M.impl.control.Searchstreet.prototype.zoomResults);goog.exportProperty(M.impl.control.Searchstreet.prototype,"addEventClickFeature",M.impl.control.Searchstreet.prototype.addEventClickFeature);goog.exportProperty(M.impl.control.Searchstreet.prototype,"getElement",M.impl.control.Searchstreet.prototype.getElement);goog.exportProperty(M.impl.control.Searchstreet.prototype,"destroy",M.impl.control.Searchstreet.prototype.destroy);
goog.exportSymbol("M.impl.control.Searchstreet.POPUP_TEMPLATE",M.impl.control.Searchstreet.POPUP_TEMPLATE);goog.exportSymbol("M.plugin.Searchstreet",M.plugin.Searchstreet);goog.exportProperty(M.plugin.Searchstreet.prototype,"name",M.plugin.Searchstreet.prototype.name);goog.exportProperty(M.plugin.Searchstreet.prototype,"addTo",M.plugin.Searchstreet.prototype.addTo);goog.exportProperty(M.plugin.Searchstreet.prototype,"destroy",M.plugin.Searchstreet.prototype.destroy);
goog.exportProperty(M.plugin.Searchstreet.prototype,"equals",M.plugin.Searchstreet.prototype.equals);goog.exportSymbol("M.control.Searchstreet",M.control.Searchstreet);goog.exportProperty(M.control.Searchstreet.prototype,"completed",M.control.Searchstreet.prototype.completed);goog.exportProperty(M.control.Searchstreet.prototype,"contadorProvincias",M.control.Searchstreet.prototype.contadorProvincias);goog.exportProperty(M.control.Searchstreet.prototype,"createView",M.control.Searchstreet.prototype.createView);
goog.exportProperty(M.control.Searchstreet.prototype,"addEvents",M.control.Searchstreet.prototype.addEvents);goog.exportProperty(M.control.Searchstreet.prototype,"querySearchProvinces",M.control.Searchstreet.prototype.querySearchProvinces);goog.exportProperty(M.control.Searchstreet.prototype,"equals",M.control.Searchstreet.prototype.equals);goog.exportProperty(M.control.Searchstreet.prototype,"getInput",M.control.Searchstreet.prototype.getInput);
goog.exportProperty(M.control.Searchstreet.prototype,"getHtml",M.control.Searchstreet.prototype.getHtml);goog.exportSymbol("M.control.Searchstreet.TEMPLATE",M.control.Searchstreet.TEMPLATE);goog.exportSymbol("M.control.Searchstreet.RESULTS_TEMPLATE",M.control.Searchstreet.RESULTS_TEMPLATE);goog.exportSymbol("M.control.Searchstreet.SEARCHING_CLASS",M.control.Searchstreet.SEARCHING_CLASS);goog.exportSymbol("M.control.Searchstreet.HIDDEN_RESULTS_CLASS",M.control.Searchstreet.HIDDEN_RESULTS_CLASS);
goog.exportSymbol("M.control.Searchstreet.MINIMUM",M.control.Searchstreet.MINIMUM); })(window.M);
