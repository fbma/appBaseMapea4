(function (M) { var $jscomp={scope:{},checkStringArgs:function(a,b,c){if(null==a)throw new TypeError("The 'this' value for String.prototype."+c+" must not be null or undefined");if(b instanceof RegExp)throw new TypeError("First argument to String.prototype."+c+" must not be a regular expression");return a+""}};
...
$jscomp.arrayIterator=function(a){var b=0;return $jscomp.iteratorPrototype(function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}})};$jscomp.iteratorPrototype=function(a){$jscomp.initSymbolIterator();a={next:a};a[$jscomp.global.Symbol.iterator]=function(){return this};return a};$jscomp.makeIterator=function(a){$jscomp.initSymbolIterator();var b=a[Symbol.iterator];return b?b.call(a):$jscomp.arrayIterator(a)};$jscomp.EXPOSE_ASYNC_EXECUTOR=!0;$jscomp.FORCE_POLYFILL_PROMISE=!1;
...
return d},"es6-impl","es3");$jscomp.polyfill("String.prototype.includes",function(a){return a?a:function(a,c){return-1!==$jscomp.checkStringArgs(this,a,"includes").indexOf(a,c||0)}},"es6-impl","es3");var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};goog.exportPath_=function(a,b,c){a=a.split(".");c=c||goog.global;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&goog.isDef(b)?c[d]=b:c=c[d]?c[d]:c[d]={}};
...
function(a,b){if(goog.inHtmlDocument_()){var c=goog.global.document;if(!goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING&&"complete"==c.readyState){if(/\bdeps.js$/.test(a))return!1;throw Error('Cannot write "'+a+'" after document load');}void 0===b?goog.IS_OLD_IE_?(b=" onreadystatechange='goog.onScriptLoad_(this, "+ ++goog.lastNonModuleScriptIndex_+")' ",c.write('<script type="text/javascript" src="'+a+'"'+b+">\x3c/script>")):goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING?goog.appendScriptSrcNode_(a):goog.writeScriptSrcNode_(a):
c.write('<script type="text/javascript">'+goog.protectScriptTag_(b)+"\x3c/script>");return!0}return!1},goog.protectScriptTag_=function(a){return a.replace(/<\/(SCRIPT)/ig,"\\x3c\\$1")},goog.needsTranspile_=function(a){if("always"==goog.TRANSPILE)return!0;if("never"==goog.TRANSPILE)return!1;goog.requiresTranspilation_||(goog.requiresTranspilation_=goog.createRequiresTranspilation_());if(a in goog.requiresTranspilation_)return goog.requiresTranspilation_[a];throw Error("Unknown language mode: "+a);
},goog.requiresTranspilation_=null,goog.lastNonModuleScriptIndex_=0,goog.onScriptLoad_=function(a,b){"complete"==a.readyState&&goog.lastNonModuleScriptIndex_==b&&goog.loadQueuedModules_();return!0},goog.writeScripts_=function(a){function b(a){if(!(a in e.written||a in e.visited)){e.visited[a]=!0;if(a in e.requires)for(var f in e.requires[a])if(!goog.isProvided_(f))if(f in e.nameToPath)b(e.nameToPath[f]);else throw Error("Undefined nameToPath for "+f);a in d||(d[a]=!0,c.push(a))}}var c=[],d={},e=goog.dependencies_;
b(a);for(a=0;a<c.length;a++){var f=c[a];goog.dependencies_.written[f]=!0}var g=goog.moduleLoaderState_;goog.moduleLoaderState_=null;for(a=0;a<c.length;a++)if(f=c[a]){var h=e.loadFlags[f]||{},k=goog.needsTranspile_(h.lang||"es3");"goog"==h.module||k?goog.importProcessedScript_(goog.basePath+f,"goog"==h.module,k):goog.importScript_(goog.basePath+f)}else throw goog.moduleLoaderState_=g,Error("Undefined script input");goog.moduleLoaderState_=g},goog.getPathFromDeps_=function(a){return a in goog.dependencies_.nameToPath?
goog.dependencies_.nameToPath[a]:null},goog.findBasePath_(),goog.global.CLOSURE_NO_DEPS||goog.importScript_(goog.basePath+"deps.js"));
...
goog.string.unescapeEntitiesUsingDom_=function(a,b){var c={"&amp;":"&","&lt;":"<","&gt;":">","&quot;":'"'},d;d=b?b.createElement("div"):goog.global.document.createElement("div");return a.replace(goog.string.HTML_ENTITY_PATTERN_,function(a,b){var e=c[a];if(e)return e;"#"==b.charAt(0)&&(b=Number("0"+b.substr(1)),isNaN(b)||(e=String.fromCharCode(b)));e||(d.innerHTML=a+" ",e=d.firstChild.nodeValue.slice(0,-1));return c[a]=e})};
...
goog.events.wrapListener=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)});return a[goog.events.LISTENER_WRAPPER_PROP_]};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});var P={plugin:{}};P.plugin.Autocomplete={};
(function(){M.plugin.Autocomplete=function(a){a=a||{};this.map_=null;this.name=M.plugin.Autocomplete.NAME;this.locality_="";M.utils.isNullOrEmpty(a.locality)||(this.locality_=a.locality);this.url_=M.config.SEARCHSTREET_URLCODINEAUTOCOMPLETE;this.minLength_=M.config.AUTOCOMPLETE_MINLENGTH;this.target_=a.target;this.resultsContainer_=a.html.querySelector("div#m-autocomplete-results");var b=this;this.target_.addEventListener("keydown",function(a){var c=b.resultsContainer_.querySelectorAll("div.autocomplete"),e=
b.resultsContainer_.querySelector(".selected");if(13===a.keyCode)for(var c=b.map_.getControls(),f=0,g=c.length;f<g;f++)"searchstreet"===c[f].name_?0>this.value.indexOf(",")?b.searchMunicipality_(this.value):(c[f].searchClick_(a),c[f].completed=!1):"searchstreetgeosearch"===c[f].name_&&(!M.utils.isNullOrEmpty(e)&&0>this.value.indexOf(",")?b.searchMunicipality_(this.value):(c[f].ctrlSearchstreet.searchClick_(a),c[f].ctrlSearchstreet.completed=!1,c[f].ctrlGeosearch.searchClick_(a)));else if(0<c.length){f=
-1;for(g=0;g<c.length;g++)c[g].classList.contains("selected")&&(f=g,e=c[g]);40===a.keyCode?-1==f?(e=c[0],e.classList.add("selected")):f<c.length-1&&(c[f].classList.remove("selected"),e=c[f+1],e.classList.add("selected")):38===a.keyCode&&(f==c.length?(e=c[c.length],e.classList.add("selected")):1<=f&&(c[f].classList.remove("selected"),e=c[f-1],e.classList.add("selected")));M.utils.isNullOrEmpty(e)||(this.value=e.innerHTML.trim(),document.getElementById("m-autcomplete").scrollTop=e.offsetTop)}});this.delayTime_=
M.config.AUTOCOMPLETE_DELAYTIME;this.timeoutKey_=null;this.limit_=M.config.AUTOCOMPLETE_LIMIT;this.searchTime_=0;this.busqMunicipioClick_=this.busqMunicipio_=!1;this.searchingResult_=this.resultsContainer_.querySelector("div#m-autocomplete-results > div#m-searching-result-autocomplete");M.Plugin.call(this)};goog.inherits(M.plugin.Autocomplete,M.Plugin);M.plugin.Autocomplete.prototype.addTo=function(a){this.map_=a;goog.dom.classlist.add(this.target_,M.plugin.Autocomplete.CLASS);goog.dom.removeChildren(this.resultsContainer_,
this.searchingResult_);goog.events.listen(this.target_,goog.events.EventType.INPUT,this.keyPress_,!1,this);goog.events.listen(this.target_,goog.events.EventType.KEYUP,this.hiddenAutocomplete_,!1,this)};M.plugin.Autocomplete.prototype.hiddenAutocomplete_=function(a){27===a.keyCode&&this.cancelSearch_(a)};M.plugin.Autocomplete.prototype.keyPress_=function(a){a.preventDefault();M.utils.isNullOrEmpty(this.timeoutKey_)||this.cancelSearch_(a);var b=this.target_.value.trim();b.length>=this.minLength_&&(this.timeoutKey_=
setTimeout(goog.bind(function(){-1!=b.indexOf(",")?this.busqMunicipio_=!0:this.busqMunicipioClick_=this.busqMunicipio_=!1;this.search_(b)},this),this.delayTime_))};M.plugin.Autocomplete.prototype.search_=function(a,b){var c=this;this.evt=b;var d;d=M.utils.addParameters(this.url_,{input:a.trim(),limit:this.limit_,codine:this.locality_});d=this.formatContent_(d," ","%20");this.searchTime_=Date.now();(function(a){M.remote.get(d).then(function(b){if(a===c.searchTime_){b=JSON.parse(b.text);b=c.parseResultsForTemplate_(b);
var d=c.map_.getControls();if(M.utils.isUndefined(b.docs)){b=0;for(var e=d.length;b<e;b++)"searchstreet"===d[b].name_?d[b].completed=!1:"searchstreetgeosearch"===d[b].name_&&(d[b].ctrlSearchstreet.completed=!1)}else if(M.utils.isUndefined(b.docs[0]))for(b=0,e=d.length;b<e;b++)"searchstreet"===d[b].name_?d[b].completed=!1:"searchstreetgeosearch"===d[b].name_&&(d[b].ctrlSearchstreet.completed=!1);else M.template.compile(M.plugin.Autocomplete.RESULTAUTOCOMPLETE,{jsonp:!0,vars:b}).then(function(a){c.resultsContainer_.innerHTML=
a.innerHTML;a=c.resultsContainer_.querySelectorAll("div.autocomplete");c.addEvents_(a);c.target_.focus();if(!0===c.busqMunicipio_)if(!0===c.busqMunicipioClick_){if(c.resultsContainer_.innerHTML="",!M.utils.isUndefined(c.evt)){a=0;for(var b=d.length;a<b;a++)"searchstreetgeosearch"===d[a].name_?(d[a].ctrlSearchstreet.searchClick_(c.evt),d[a].ctrlSearchstreet.completed=!1,d[a].ctrlGeosearch.searchClick_(c.evt)):"searchstreet"===d[a].name_&&(d[a].searchClick_(c.evt),d[a].completed=!1);c.busqMunicipioClick_=
!1}}else{a=c.resultsContainer_.querySelectorAll("div.autocomplete");for(var b=0,e=d.length;b<e;b++)if("searchstreetgeosearch"===d[b].name_)if(!0===d[b].ctrlSearchstreet.completed)d[b].ctrlSearchstreet.completed=!1,c.resultsContainer_.innerHTML="";else for(var f=0,g=a.length;f<g;f++)c.evtClickMunicipaly_(a[f]);else if("searchstreet"===d[b].name_)if(!0===d[b].completed)d[b].completed=!1,c.resultsContainer_.innerHTML="";else for(f=0,g=a.length;f<g;f++)c.evtClickMunicipaly_(a[f])}else for(a=0,b=d.length;a<
b;a++)"searchstreet"===d[a].name_?!0===d[a].completed&&(c.resultsContainer_.innerHTML="",d[a].completed=!1):"searchstreetgeosearch"===d[a].name_&&!0===d[a].ctrlSearchstreet.completed&&(c.resultsContainer_.innerHTML="",d[a].ctrlSearchstreet.completed=!1)});goog.dom.classlist.remove(c.resultsContainer_,M.plugin.Autocomplete.MINIMUM);goog.dom.removeChildren(c.resultsContainer_,c.searchingResult_)}})})(this.searchTime_)};M.plugin.Autocomplete.prototype.evtClickMunicipaly_=function(a){var b=this;goog.events.listen(a,
goog.events.EventType.CLICK,function(a){b.clickMunicipaly_()},!1,this)};M.plugin.Autocomplete.prototype.parseResultsForTemplate_=function(a){a=a.autocompletarDireccionMunicipioResponse.autocompletarDireccionMunicipioReturn.autocompletarDireccionMunicipioReturn;var b=[];if(!0===this.busqMunicipio_)if(M.utils.isUndefined(a))this.resultsContainer_.innerHTML="";else{!1===a instanceof Array&&(a=[a]);for(var c=0,d=a.length;c<d;c++){var e=a[c].split(",");b.push(e[0]+" "+e[1]+", "+e[3]+" ("+e[e.length-1]+
")")}a=b}else if(!1===a instanceof Array){if(b.push(a),a=b,!M.utils.isUndefined(a[0]))for(b=0,c=a.length;b<c;b++)a[b]=this.formatContent_(a[b],","," ")}else for(b=0,c=a.length;b<c;b++)a[b]=this.formatContent_(a[b],","," ");return{docs:a}};M.plugin.Autocomplete.prototype.addEvents_=function(a){for(var b=0,c=a.length;b<c;b++)this.addEventSearchMunicipality_(a[b])};M.plugin.Autocomplete.prototype.addEventSearchMunicipality_=function(a){goog.events.listen(a,goog.events.EventType.CLICK,function(b){this.target_.value=
a.innerHTML.trim();if(M.utils.isNullOrEmpty(this.locality_))this.searchMunicipality_(a.innerHTML,b);else{var c=this.map_.getControls();this.resultsContainer_.innerHTML="";c.forEach(function(a){"searchstreet"===a.name_?(a.searchClick_(b),a.completed=!1):"searchstreetgeosearch"===a.name_&&(a.ctrlSearchstreet.searchClick_(b),a.ctrlSearchstreet.completed=!1,a.ctrlGeosearch.searchClick_(b))})}},!1,this)};M.plugin.Autocomplete.prototype.searchMunicipality_=function(a,b){this.busqMunicipio_=!0;this.search_(a.trim()+
",",b)};M.plugin.Autocomplete.prototype.clickMunicipaly_=function(){this.busqMunicipioClick_=!0};M.plugin.Autocomplete.prototype.formatContent_=function(a,b,c){return a.replace(new RegExp(b,"g"),c)};M.plugin.Autocomplete.prototype.cancelSearch_=function(a){clearTimeout(this.timeoutKey_);this.minLength_<=this.target_.value.length&&13!==a.keyCode&&27!==a.keyCode?(M.utils.isNullOrEmpty(this.resultsContainer_.parentElement.querySelector("#m-searchstreet-results>div"))?goog.dom.classlist.add(this.resultsContainer_,
"results-panel"):(goog.dom.classlist.add(this.resultsContainer_,"results-panel-content"),goog.dom.classlist.remove(this.resultsContainer_,"results-panel")),goog.dom.appendChild(this.resultsContainer_,this.searchingResult_),goog.dom.classlist.add(this.resultsContainer_.parentElement,M.plugin.Autocomplete.SEARCHING_CLASS),goog.dom.classlist.add(this.resultsContainer_,M.plugin.Autocomplete.MINIMUM)):(this.searchTime_=0,goog.dom.classlist.remove(this.resultsContainer_.parentElement,M.plugin.Autocomplete.SEARCHING_CLASS),
goog.dom.classlist.remove(this.resultsContainer_,M.plugin.Autocomplete.MINIMUM),goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_),this.resultsContainer_.innerHTML="")};M.plugin.Autocomplete.prototype.destroy=function(){this.map_.removeControls(this);this.map_=null;this.locality_="";this.searchingResult_=this.busqMunicipioClick_=this.busqMunicipio_=this.searchTime_=this.limit_=this.timeoutKey_=this.delayTime_=this.resultsContainer_=this.target_=this.minLength_=this.url_=null};M.plugin.Autocomplete.CLASS=
"m-plugin-autocomplete";M.plugin.Autocomplete.SEARCHING_CLASS="m-searching";M.plugin.Autocomplete.RESULTAUTOCOMPLETE="resultautocomplete.html";M.plugin.Autocomplete.MINIMUM="minimum";M.plugin.Autocomplete.prototype.equals=function(a){return a instanceof M.plugin.Autocomplete?!0:!1};M.plugin.Autocomplete.NAME="autocomplete"})();P.layer={};P.layer.Geosearch={};(function(){M.layer.Geosearch=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?new M.impl.layer.Geosearch:c;M.utils.isUndefined(M.impl.layer.Geosearch)&&M.exception("La implementaci\u00f3n usada no puede crear capas Geosearch");M.layer.Vector.call(this,this,b,c)};goog.inherits(M.layer.Geosearch,M.layer.Vector);M.layer.Geosearch.prototype.equals=function(a){return!1}})();P.control={};P.control.Geosearch={};
(function(){M.control.Geosearch=function(a,b,c,d){M.utils.isUndefined(M.impl.control.Geosearch)&&M.exception("La implementaci\u00f3n usada no puede crear controles Geosearch");this.searchingResult_=this.resultsScrollContainer_=this.resultsContainer_=this.element_=this.input_=null;this.searchTime_=0;this.url_=a;this.core_=b;this.handler_=c;this.searchUrl_=M.utils.concatUrlPaths([this.url_,this.core_,this.handler_]);this.helpUrl_=M.utils.concatUrlPaths([this.url_,this.core_,"/help"]);this.searchParameters_=
d;M.utils.isNullOrEmpty(this.searchParameters_)||(M.utils.isNullOrEmpty(this.searchParameters_.rows)&&(this.searchParameters_.rows=M.config.GEOSEARCH_ROWS),this.searchUrl_=M.utils.addParameters(this.searchUrl_,this.searchParameters_));this.results_=[];this.helpShown_=!1;this.scrollIsUp_=!0;this.spatialSearch_=!1;this.facadeMap_=null;a=new M.impl.control.Geosearch;M.Control.call(this,a,M.control.Geosearch.NAME)};goog.inherits(M.control.Geosearch,M.Control);M.control.Geosearch.prototype.createView=
function(a){var b=this;this.facadeMap_=a;return new Promise(function(a,d){M.template.compile(M.control.Geosearch.TEMPLATE,{jsonp:!0}).then(function(c){b.addEvents(c);a(c)})})};M.control.Geosearch.prototype.addEvents=function(a){this.element_=a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-geosearch-search-input"];goog.events.listen(this.input_,goog.events.EventType.KEYUP,this.searchClick_,!1,this);
a=this.element_.getElementsByTagName("button")["m-geosearch-search-btn"];goog.events.listen(a,goog.events.EventType.CLICK,this.searchClick_,!1,this);var b=this.element_.getElementsByTagName("button")["m-geosearch-help-btn"];goog.events.listen(b,goog.events.EventType.CLICK,function(a){a.preventDefault();goog.dom.classlist.toggle(b,"shown");this.helpClick_()},!1,this);a=this.element_.getElementsByTagName("button")["m-geosearch-clear-btn"];goog.events.listen(a,goog.events.EventType.CLICK,this.clearClick_,
!1,this);this.resultsContainer_=this.element_.querySelector("div#m-geosearch-results");M.utils.enableTouchScroll(this.resultsContainer_);this.searchingResult_=this.element_.querySelector("div#m-geosearch-results > div#m-searching-result")};M.control.Geosearch.prototype.searchClick_=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)this.results_.length=0,a=this.input_.value,M.utils.isNullOrEmpty(a)?M.dialog.info("Debe introducir una b\u00fasqueda."):this.search_(a,
this.showResults_)};M.control.Geosearch.prototype.resultClick_=function(a){a.preventDefault();M.window.WIDTH<=M.config.MOBILE_WIDTH&&(a.target=this.resultsContainer_.querySelector("div.page > div.g-cartografia-flecha-arriba"),this.resultsClick_(a));this.getImpl().facadeMap_.removePopup();a=a.currentTarget.id;this.getImpl().resultClick(a)};M.control.Geosearch.prototype.search_=function(a,b){goog.dom.appendChild(this.resultsContainer_,this.searchingResult_);this.searchTime_=Date.now();goog.dom.classlist.add(this.element_,
M.control.Geosearch.SEARCHING_CLASS);var c=M.utils.addParameters(this.searchUrl_,{q:a,start:this.results_.length,srs:this.facadeMap_.getProjection().code}),d=this;(function(a){M.remote.get(c).then(function(c){if(a===d.searchTime_){var e;try{e=JSON.parse(c.text)}catch(h){M.exception("La respuesta no es un JSON v\u00e1lido: "+h)}b.call(d,e);goog.dom.classlist.remove(d.element_,M.control.Geosearch.SEARCHING_CLASS)}})})(this.searchTime_)};M.control.Geosearch.prototype.showResults_=function(a){this.getImpl().clear();
this.drawResults(a);var b=this.parseResultsForTemplate_(a),c=this;M.template.compile(M.control.Geosearch.RESULTS_TEMPLATE,{jsonp:!0,vars:b}).then(function(b){goog.dom.classlist.remove(c.resultsContainer_,M.control.Geosearch.HIDDEN_RESULTS_CLASS);M.utils.isNullOrEmpty(c.resultsScrollContainer_)||goog.events.unlisten(c.resultsScrollContainer_,goog.events.EventType.SCROLL,c.resultsScroll_,!1,c);for(var d=c.resultsContainer_.querySelectorAll(".result"),f,g=0,h=d.length;g<h;g++)f=d.item(g),goog.events.unlisten(f,
goog.events.EventType.CLICK,c.resultClick_,!1,c);0<a.response.docs.length&&c.zoomToResults();d=c.resultsContainer_.querySelector("div.page > div.g-cartografia-flecha-arriba");M.utils.isNullOrEmpty(d)||goog.events.unlisten(d,goog.events.EventType.CLICK,c.resultsClick_,!1,c);c.resultsContainer_.innerHTML=b.innerHTML;c.resultsScrollContainer_=c.resultsContainer_.querySelector("div#m-geosearch-results-scroll");M.utils.enableTouchScroll(c.resultsScrollContainer_);goog.events.listen(c.resultsScrollContainer_,
goog.events.EventType.SCROLL,c.resultsScroll_,!1,c);d=c.resultsContainer_.getElementsByClassName("result");g=0;for(h=d.length;g<h;g++)f=d.item(g),goog.events.listen(f,goog.events.EventType.CLICK,c.resultClick_,!1,c);d=c.resultsContainer_.querySelector("div.page > div.g-cartografia-flecha-arriba");goog.events.listen(d,goog.events.EventType.CLICK,c.resultsClick_,!1,c);c.checkScrollSearch_(a);c.fire(M.evt.COMPLETED)})};M.control.Geosearch.prototype.drawResults=function(a){this.getImpl().drawResults(a)};
M.control.Geosearch.prototype.drawNewResults=function(a){this.getImpl().drawNewResults(a)};M.control.Geosearch.prototype.zoomToResults=function(){this.getImpl().zoomToResults()};M.control.Geosearch.prototype.getInput=function(){return this.input_};M.control.Geosearch.prototype.appendResults_=function(a){this.drawNewResults(a);var b=this.parseResultsForTemplate_(a,!0),c=this;M.template.compile(M.control.Geosearch.RESULTS_TEMPLATE,{jsonp:!0,vars:b}).then(function(b){b=b.getElementsByTagName("div")["m-geosearch-results-scroll"].children;
for(var d;null!==(d=b.item(0));)c.resultsScrollContainer_.appendChild(d),goog.events.listen(d,goog.events.EventType.CLICK,c.resultClick_,!1,c);c.resultsContainer_.getElementsByTagName("span")["m-geosearch-page-found"].innerHTML=c.results_.length;c.checkScrollSearch_(a)})};M.control.Geosearch.prototype.resultsScroll_=function(a){a=a.target;var b=goog.style.getSize(a).height;(a=15>=a.scrollHeight-a.scrollTop-b)&&this.scrollIsUp_?(this.scrollIsUp_=!1,this.scrollSearch_()):a||(this.scrollIsUp_=!0)};M.control.Geosearch.prototype.scrollSearch_=
function(){this.getImpl().unselectResults(!0);this.getImpl().setNewResultsAsDefault();this.search_(this.input_.value,this.appendResults_)};M.control.Geosearch.prototype.helpClick_=function(a){if(!0===this.helpShown_)this.getImpl().hideHelp(),this.helpShown_=!1;else{var b=this;M.remote.get(this.helpUrl_).then(function(a){var c;try{c=JSON.parse(a.text)}catch(e){M.exception("La respuesta no es un JSON v\u00e1lido: "+e)}M.template.compile(M.control.Geosearch.HELP_TEMPLATE,{jsonp:!0,vars:{entities:c}}).then(function(a){b.getImpl().showHelp(a);
b.helpShown_=!0})})}};M.control.Geosearch.prototype.clearClick_=function(a){goog.dom.classlist.remove(this.element_,"shown");M.utils.isNullOrEmpty(this.input_)||(this.input_.value="");M.utils.isNullOrEmpty(this.resultsContainer_)||(this.resultsContainer_.innerHTML="");M.utils.isNullOrEmpty(this.resultsScrollContainer_)||(this.resultsScrollContainer_.innerHTML="",this.resultsScrollContainer_=null);this.results_.length=0;goog.dom.classlist.remove(this.resultsContainer_,M.control.Geosearch.HIDDEN_RESULTS_CLASS);
this.getImpl().clear();this.spatialSearch_=!1};M.control.Geosearch.prototype.resultsClick_=function(a){goog.dom.classlist.add(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra-search");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-arriba");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsContainer_,M.control.Geosearch.HIDDEN_RESULTS_CLASS)};M.control.Geosearch.prototype.equals=function(a){var b=!1;
a instanceof M.control.Geosearch&&(b=this.name===a.name);return b};M.control.Geosearch.prototype.parseResultsForTemplate_=function(a,b){var c="";M.utils.isNullOrEmpty(this.input_)||(c=this.input_.value);var d;M.utils.isUndefined(a.spatial_response)?(d=a.response.numFound,this.spatialSearch_=!1):(d=a.spatial_response.numFound,this.spatialSearch_=!0);var e=this.getDocsFromResults_(a);this.results_=!0===b?this.results_.concat(e):e;a=this.spatialSearch_&&M.utils.isNullOrEmpty(a.spatial_response.docs);
return 0!==d?{docs:e,total:d,partial:a}:{docs:e,total:d,notResutls:!0,query:c}};M.control.Geosearch.prototype.getDocsFromResults_=function(a){var b=[],b=this.spatialSearch_?a.spatial_response.docs:a.response.docs,c=["geom","_version_","keywords","solrid"];return b=b.map(function(a){var b=[],d;for(d in a)M.utils.includes(c,d)||b.push({key:M.utils.beautifyAttributeName(d),value:a[d]});return{solrid:a.solrid,attributes:b}})};M.control.Geosearch.prototype.checkScrollSearch_=function(a){a=M.utils.isUndefined(a.spatial_response)?
a.response.numFound:a.spatial_response.numFound;this.results_.length!==a||M.utils.isNullOrEmpty(this.resultsScrollContainer_)||goog.events.unlisten(this.resultsScrollContainer_,goog.events.EventType.SCROLL,this.resultsScroll_,!1,this)};M.control.Geosearch.NAME="geosearch";M.control.Geosearch.TEMPLATE="geosearch.html";M.control.Geosearch.RESULTS_TEMPLATE="geosearchresults.html";M.control.Geosearch.HELP_TEMPLATE="geosearchhelp.html";M.control.Geosearch.SEARCHING_CLASS="m-searching";M.control.Geosearch.HIDDEN_RESULTS_CLASS=
"hidden"})();P.impl={};P.impl.utils={};P.impl.utils.Geosearch={};
(function(){M.impl.utils.getCentroidCoordinate=function(a){var b;a.getType()===M.geom.wkt.type.POINT?b=a.getCoordinates():a.getType()===M.geom.wkt.type.LINE_STRING?(b=a.getCoordinates(),a=Math.floor(b.length/2),b=b[a]):a.getType()===M.geom.wkt.type.LINEAR_RING?(b=a.getCoordinates(),a=Math.floor(b.length/2),b=b[a]):a.getType()===M.geom.wkt.type.POLYGON?b=M.impl.utils.getCentroidCoordinate(a.getInteriorPoint()):a.getType()===M.geom.wkt.type.MULTI_POINT?(b=a.getPoints(),a=Math.floor(b.length/2),b=M.impl.utils.getCentroidCoordinate(b[a])):
a.getType()===M.geom.wkt.type.MULTI_LINE_STRING?(b=a.getLineStrings(),a=Math.floor(b.length/2),b=M.impl.utils.getCentroidCoordinate(b[a])):a.getType()===M.geom.wkt.type.MULTI_POLYGON?(b=a.getInteriorPoints(),b=M.impl.utils.getCentroidCoordinate(b)):a.getType()===M.geom.wkt.type.CIRCLE?b=a.getCenter():a.getType()===M.geom.wkt.type.GEOMETRY_COLLECTION&&(b=a.getGeometries(),a=Math.floor(b.length/2),b=M.impl.utils.getCentroidCoordinate(b[a]));return b}})();P.impl.geosearch={};P.impl.geosearch.style={};
(function(){M.impl.geosearch={};M.impl.geosearch.style={};M.impl.geosearch.style.initialized=!1;M.impl.geosearch.style.init=function(){if(!1===M.impl.geosearch.style.initialized){M.impl.geosearch.style.initialized=!0;M.impl.geosearch.style.DEFAULT={};var a=document.createElement("IMG");a.src=M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24.svg"]);a.width="24";a.height="24";a.crossOrigin="anonymous";M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.POINT]=new ol.style.Style({image:new ol.style.Icon({img:a,
imgSize:[24,24]})});M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.LINE_STRING]=new ol.style.Style({fill:new ol.style.Fill({color:"#A15BD7"}),stroke:new ol.style.Stroke({color:"#A15BD7",width:2})});M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.POLYGON]=new ol.style.Style({image:new ol.style.Icon({img:a,imgSize:[24,24]})});M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.MULTI_POINT]=M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.POINT];M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.LINEAR_RING]=M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.LINE_STRING];
M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.MULTI_LINE_STRING]=M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.LINE_STRING];M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.MULTI_POLYGON]=M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.POLYGON];M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.CIRCLE]=M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.POLYGON];M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.GEOMETRY_COLLECTION]=M.impl.geosearch.style.DEFAULT[M.geom.wkt.type.POLYGON];M.impl.geosearch.style.NEW=
{};a=document.createElement("IMG");a.src=M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24-new.svg"]);a.width="24";a.height="24";a.crossOrigin="anonymous";M.impl.geosearch.style.NEW[M.geom.wkt.type.POINT]=new ol.style.Style({image:new ol.style.Icon({img:a,imgSize:[24,24]})});M.impl.geosearch.style.NEW[M.geom.wkt.type.LINE_STRING]=new ol.style.Style({fill:new ol.style.Fill({color:"#e2951b"}),stroke:new ol.style.Stroke({color:"#e2951b",width:2})});M.impl.geosearch.style.NEW[M.geom.wkt.type.POLYGON]=
new ol.style.Style({image:new ol.style.Icon({img:a,imgSize:[24,24]})});M.impl.geosearch.style.NEW[M.geom.wkt.type.MULTI_POINT]=M.impl.geosearch.style.NEW[M.geom.wkt.type.POINT];M.impl.geosearch.style.NEW[M.geom.wkt.type.LINEAR_RING]=M.impl.geosearch.style.NEW[M.geom.wkt.type.LINE_STRING];M.impl.geosearch.style.NEW[M.geom.wkt.type.MULTI_LINE_STRING]=M.impl.geosearch.style.NEW[M.geom.wkt.type.LINE_STRING];M.impl.geosearch.style.NEW[M.geom.wkt.type.MULTI_POLYGON]=M.impl.geosearch.style.NEW[M.geom.wkt.type.POLYGON];
M.impl.geosearch.style.NEW[M.geom.wkt.type.CIRCLE]=M.impl.geosearch.style.NEW[M.geom.wkt.type.POLYGON];M.impl.geosearch.style.NEW[M.geom.wkt.type.GEOMETRY_COLLECTION]=M.impl.geosearch.style.NEW[M.geom.wkt.type.POLYGON];M.impl.geosearch.style.SELECTED={};a=document.createElement("IMG");a.src=M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24-sel.svg"]);a.width="24";a.height="24";a.crossOrigin="anonymous";M.impl.geosearch.style.SELECTED[M.geom.wkt.type.POINT]=new ol.style.Style({image:new ol.style.Icon({img:a,
imgSize:[24,24]})});M.impl.geosearch.style.SELECTED[M.geom.wkt.type.LINE_STRING]=new ol.style.Style({fill:new ol.style.Fill({color:"#fcfcfc"}),stroke:new ol.style.Stroke({color:"#3589d1",width:2})});M.impl.geosearch.style.SELECTED[M.geom.wkt.type.POLYGON]=new ol.style.Style({fill:new ol.style.Fill({color:"rgba(240, 220, 255, 0.2)"}),stroke:new ol.style.Stroke({color:"#a15bd7",width:2})});M.impl.geosearch.style.SELECTED[M.geom.wkt.type.MULTI_POINT]=M.impl.geosearch.style.SELECTED[M.geom.wkt.type.POINT];
M.impl.geosearch.style.SELECTED[M.geom.wkt.type.LINEAR_RING]=M.impl.geosearch.style.SELECTED[M.geom.wkt.type.LINE_STRING];M.impl.geosearch.style.SELECTED[M.geom.wkt.type.MULTI_LINE_STRING]=M.impl.geosearch.style.SELECTED[M.geom.wkt.type.LINE_STRING];M.impl.geosearch.style.SELECTED[M.geom.wkt.type.MULTI_POLYGON]=M.impl.geosearch.style.SELECTED[M.geom.wkt.type.POLYGON];M.impl.geosearch.style.SELECTED[M.geom.wkt.type.CIRCLE]=M.impl.geosearch.style.SELECTED[M.geom.wkt.type.POLYGON];M.impl.geosearch.style.SELECTED[M.geom.wkt.type.GEOMETRY_COLLECTION]=
M.impl.geosearch.style.SELECTED[M.geom.wkt.type.POLYGON]}}})();P.impl.layer={};P.impl.layer.Geosearch={};
(function(){M.impl.layer.Geosearch=function(a,b){a=void 0===a?"geosearch":a;b=void 0===b?{}:b;this.wktFormatter_=new ol.format.WKT;this.popup_=null;this.selectedFeatures_=[];b.displayInLayerSwitcher||(b.displayInLayerSwitcher=!1);this.name=a;M.impl.layer.Vector.call(this,b)};goog.inherits(M.impl.layer.Geosearch,M.impl.layer.Vector);M.impl.layer.Geosearch.prototype.addTo=function(a){M.impl.layer.Geosearch.superClass_.addTo.call(this,a);this.ol3Layer.setSource(new ol.source.Vector({useSpatialIndex:!1}))};M.impl.layer.Geosearch.prototype.drawResults=
function(a){var b=ol.proj.get(this.map.getProjection().code),c=[];M.utils.isNullOrEmpty(a.spatial_response)||(c=a.spatial_response.docs);M.utils.isNullOrEmpty(c)&&(c=a.response.docs);a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geosearch.setStyleFeature_(c,M.style.state.DEFAULT);this.wrapComplexFeature_(c);return M.impl.Feature.olFeature2Facade(c)},this);this.facadeVector_.addFeatures(a)};M.impl.layer.Geosearch.prototype.drawNewResults=
function(a){var b=ol.proj.get(this.map.getProjection().code),c;M.utils.isNullOrEmpty(a.spatial_response)?M.utils.isNullOrEmpty(a.response)||(c=a.response.docs):c=a.spatial_response.docs;a=c.map(function(a){var c=this.wktFormatter_.readFeature(a.geom,{dataProjection:b});c.setId(a.solrid);c.setProperties(a);M.impl.layer.Geosearch.setStyleFeature_(c,M.style.state.NEW);return M.impl.Feature.olFeature2Facade(c)},this);this.facadeVector_.addFeatures(a)};M.impl.layer.Geosearch.prototype.clear=function(a){this.map.removePopup();
this.facadeVector_.clear()};M.impl.layer.Geosearch.prototype.selectFeatures=function(a,b,c,d){this.unselectFeatures();this.selectedFeatures_=a;a=a.map(M.impl.Feature.facade2OLFeature);M.impl.layer.Geosearch.setStyleFeature_(a,M.style.state.SELECTED);a=this.parseFeaturesForTemplate_(a);var e=this;M.template.compile(M.impl.layer.Geosearch.POPUP_RESULT,{jsonp:!0,vars:a,parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-pin",title:"Geosearch",content:a};var c=e.map.getPopup();M.utils.isNullOrEmpty(c)?
(c=new M.Popup({panMapIfOutOfView:!d,ani:null}),c.addTab(a),e.map.addPopup(c,b)):c.addTab(a);c.on(M.evt.DESTROY,function(){this.internalUnselectFeatures_(!0)},e)})};M.impl.layer.Geosearch.prototype.selectFeatureBySolrid=function(a){a=this.facadeVector_.getFeatureById(a);this.selectedFeatures_=[a];var b=a.getImpl().getOLFeature().getGeometry(),c=M.impl.utils.getCentroidCoordinate(b);this.unselectFeatures();this.selectFeatures([a],c,null,!0);this.map.setBbox(b.getExtent())};M.impl.layer.Geosearch.prototype.parseFeaturesForTemplate_=
function(a){var b={features:[]};a.forEach(function(a){var c=["geom","_version_","keywords","solrid",a.getGeometryName()],e=a.getProperties(),f=[],g;for(g in e)M.utils.includes(c,g.toLowerCase())||f.push({key:M.utils.beautifyAttributeName(g),value:e[g]});a={solrid:a.getId(),attributes:f};b.features.push(a)});return b};M.impl.layer.Geosearch.prototype.wrapComplexFeature_=function(a){var b=a.getGeometry();if(b.getType()===M.geom.wkt.type.POLYGON||b.getType()===M.geom.wkt.type.MULTI_POLYGON){var c;c=
b.getType()===M.geom.wkt.type.POLYGON?b.getInteriorPoint():b.getInteriorPoints();b=new ol.geom.GeometryCollection([c,b]);a.setGeometry(b)}};M.impl.layer.Geosearch.prototype.unselectFeatures=function(a,b){this.internalUnselectFeatures_()};M.impl.layer.Geosearch.prototype.internalUnselectFeatures_=function(a){0<this.selectedFeatures_.length&&(M.impl.layer.Geosearch.setStyleFeature_(this.selectedFeatures_.map(M.impl.Feature.facade2OLFeature),M.style.state.DEFAULT),this.selectedFeatures_.length=0,a||
this.map.removePopup())};M.impl.layer.Geosearch.prototype.setNewResultsAsDefault=function(){M.impl.layer.Geosearch.setStyleFeature_(this.facadeVector_.getFeatures().map(M.impl.Feature.facade2OLFeature),M.style.state.DEFAULT)};M.impl.layer.Geosearch.prototype.destroy=function(){var a=this.map.getMapImpl();M.utils.isNullOrEmpty(this.ol3Layer)||(a.removeLayer(this.ol3Layer),this.ol3Layer=null);this.name=this.selectedFeatures_=this.popup_=this.wktFormatter_=this.map=null};M.impl.layer.Geosearch.prototype.equals=
function(a){var b=!1;a instanceof M.impl.layer.Geosearch&&(b=(b=this.url===a.url)&&this.name===a.name);return b};M.impl.layer.Geosearch.setStyleFeature_=function(a,b){M.impl.geosearch.style.init();M.utils.isArray(a)||(a=[a]);a.forEach(function(a){var c=a.getGeometry().getType();M.utils.isNullOrEmpty(b)||b===M.style.state.DEFAULT?a.setStyle(M.impl.geosearch.style.DEFAULT[c]):b===M.style.state.NEW?a.setStyle(M.impl.geosearch.style.NEW[c]):b===M.style.state.SELECTED&&a.setStyle(M.impl.geosearch.style.SELECTED[c])})};
M.impl.layer.Geosearch.POPUP_RESULT="geosearchfeaturepopup.html"})();goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);goog.dom.classes.set(a,c.join(" "));return c.length==e};
...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};P.impl.control={};P.impl.control.Geosearch={};
(function(){M.impl.control.Geosearch=function(a){a=void 0===a?{}:a;this.helpHtml_=this.facadeMap_=null;this.layer_=new M.layer.Geosearch({name:a.layerName})};goog.inherits(M.impl.control.Geosearch,M.impl.Control);M.impl.control.Geosearch.prototype.addTo=function(a,b){this.facadeMap_=a;a.addLayers(this.layer_);ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.Geosearch.prototype.unselectResults=function(a){this.layer_.getImpl().unselectFeatures(a)};M.impl.control.Geosearch.prototype.setNewResultsAsDefault=
function(){this.layer_.getImpl().setNewResultsAsDefault()};M.impl.control.Geosearch.prototype.drawResults=function(a){this.layer_.getImpl().drawResults(a)};M.impl.control.Geosearch.prototype.drawNewResults=function(a){this.layer_.getImpl().drawNewResults(a)};M.impl.control.Geosearch.prototype.zoomToResults=function(){var a=ol.extent.boundingExtent(this.layer_.getImpl().getOL3Layer().getSource().getFeatures().map(function(a){return ol.extent.getCenter(a.getGeometry().getExtent())}));this.facadeMap_.setBbox(a)};
M.impl.control.Geosearch.prototype.getLayer=function(){return this.layer_};M.impl.control.Geosearch.prototype.resultClick=function(a){this.layer_.getImpl().selectFeatureBySolrid(a)};M.impl.control.Geosearch.prototype.hideHelp=function(){M.utils.isNullOrEmpty(this.helpHtml_)||(this.facadeMap_.getMapImpl().getTargetElement().removeChild(this.helpHtml_),this.helpHtml_=null)};M.impl.control.Geosearch.prototype.showHelp=function(a){var b=this.facadeMap_.getMapImpl().getTargetElement();M.utils.isNullOrEmpty(this.helpHtml_)||
b.removeChild(this.helpHtml_);this.helpHtml_=a;b.appendChild(this.helpHtml_)};M.impl.control.Geosearch.prototype.clear=function(){this.layer_.getImpl().clear()};M.impl.control.Geosearch.prototype.destroy=function(){this.clear();goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.facadeMap_.getMapImpl().removeControl(this);this.layer_=this.helpHtml_=this.facadeMap_=null}})();P.control.Searchstreet={};
(function(){M.control.Searchstreet=function(a,b){M.utils.isUndefined(M.impl.control.Searchstreet)&&M.exception("La implementaci\u00f3n usada no puede crear controles Searchstreet");this.resultsContainer_=this.element_=this.button_=this.input_=null;this.searchTime_=0;this.name_="searchstreet";this.searchUrl_=a;this.provincia_=this.municipio_=null;this.provincias_="huelva sevilla c\u00f3rdoba ja\u00e9n c\u00e1diz m\u00e1laga granada almer\u00eda".split(" ");M.utils.isUndefined(b)||(this.codIne_=b,this.searchCodIne_=
M.config.SEARCHSTREET_URLCOMPROBARINE);this.minAutocomplete_=M.config.AUTOCOMPLETE_MINLENGTH;this.resultsAutocomplete_=this.facadeMap_=null;this.completed=!1;this.respuestasProvincias_=[];this.contadorProvincias=0;this.resultsScrollContainer_=null;a=new M.impl.control.Searchstreet;M.Control.call(this,a)};goog.inherits(M.control.Searchstreet,M.Control);M.control.Searchstreet.prototype.createView=function(a){var b=this;this.facadeMap_=a;return new Promise(function(a,d){M.template.compile(M.control.Searchstreet.TEMPLATE,
{jsonp:!0}).then(function(c){b.addEvents(c);a(c)})})};M.control.Searchstreet.prototype.addEvents=function(a){var b=this;this.element_=a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-searchstreet-search-input"];this.button_=this.element_.getElementsByTagName("button")["m-searchstreet-search-btn"];this.clear_=this.element_.getElementsByTagName("button")["m-searchstreet-clear-btn"];goog.events.listen(this.button_,
goog.events.EventType.CLICK,this.searchClick_,!1,this);goog.events.listen(this.clear_,goog.events.EventType.CLICK,this.clearSearchs_,!1,this);this.resultsContainer_=this.element_.getElementsByTagName("div")["m-searchstreet-results"];this.resultsAutocomplete_=this.element_.getElementsByTagName("div")["m-autocomplete-results"];this.searchingResult_=this.element_.querySelector("div#m-searchstreet-results > div#m-searching-result-searchstreet");M.utils.isUndefined(this.codIne_)||M.utils.isNullOrEmpty(this.codIne_)||
(a=M.utils.addParameters(this.searchCodIne_,{codigo:this.codIne_}),M.remote.get(a).then(function(a){var c;try{M.utils.isNullOrEmpty(a.text)||(c=JSON.parse(a.text),M.utils.isNullOrEmpty(c.comprobarCodIneResponse.comprobarCodIneReturn)?M.dialog.error("El c\u00f3digo del municipio '"+b.codIne_+"' no es v\u00e1lido"):(b.getMunProv_(c),b.element_.getElementsByTagName("span").codIne.innerHTML="B\u00fasquedas en "+b.municipio_+"  ("+b.provincia_+")"))}catch(e){M.exception("La respuesta no es un JSON v\u00e1lido: "+
e)}}));goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_)};M.control.Searchstreet.prototype.getMunProv_=function(a){this.provincia_=a.comprobarCodIneResponse.comprobarCodIneReturn.comprobarCodIneReturn.nombreProvincia;this.municipio_=a.comprobarCodIneResponse.comprobarCodIneReturn.comprobarCodIneReturn.nombreMunicipio};M.control.Searchstreet.prototype.searchClick_=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)if(goog.dom.classlist.remove(this.resultsAutocomplete_,
M.control.Searchstreet.MINIMUM),goog.dom.removeChildren(this.resultsAutocomplete_,this.resultsAutocomplete_.querySelector("div#m-searching-result-autocomplete")),a=this.input_.value,M.utils.isNullOrEmpty(a))M.dialog.error("Debe introducir una b\u00fasqueda.");else if(this.completed=a.length<this.minAutocomplete_?!1:!0,M.utils.isUndefined(this.codIne_)||M.utils.isNullOrEmpty(this.codIne_))this.search_(a,this.showResults_);else{var b=a.indexOf(",");-1<a.indexOf(",")&&(a=a.substring(0,b));this.search_(a+
", "+this.municipio_+" ("+this.provincia_+")",this.showResults_)}};M.control.Searchstreet.prototype.search_=function(a,b){var c=this,d=null;this.municipio_=this.provincia_=null;goog.dom.appendChild(this.resultsContainer_,this.searchingResult_);goog.dom.classlist.add(this.element_,M.control.Searchstreet.SEARCHING_CLASS);goog.dom.classlist.add(this.resultsContainer_,M.control.Searchstreet.MINIMUM);a=M.utils.addParameters(M.config.SEARCHSTREET_NORMALIZAR,{cadena:a});M.remote.get(a).then(function(a){a=
JSON.parse(a.text).normalizarResponse.normalizarReturn;c.provincia_=M.utils.beautifyString(a.provincia);c.municipio_=M.utils.beautifyString(a.municipio);if(M.utils.isNullOrEmpty(c.provincia_))if(M.utils.isNullOrEmpty(c.provincia_)&&!M.utils.isNullOrEmpty(c.municipio_)){c.searchTime_=Date.now();c.respuestasProvincias_=[];for(var e=c.contadorProvincias=0,g=c.provincias_.length;e<g;e++)d=M.utils.addParameters(c.searchUrl_,{streetname:a.nombreVia,streetNumber:a.numeroPortal,streetType:a.tipoVia,municipio:c.municipio_,
provincia:c.provincias_[e],srs:c.facadeMap_.getProjection().code}),c.querySearchProvinces(d,c.provincias_[e],b)}else d=M.utils.addParameters(c.searchUrl_,{streetname:a.direccionSinNormalizar,streetNumber:null,streetType:null,municipio:null,provincia:null,srs:c.facadeMap_.getProjection().code}),c.searchTime_=Date.now(),c.querySearch_(d,null,b);else d=M.utils.addParameters(c.searchUrl_,{streetname:a.nombreVia,streetNumber:a.numeroPortal,streetType:a.tipoVia,municipio:c.municipio_,provincia:c.provincia_,
srs:c.facadeMap_.getProjection().code}),c.searchTime_=Date.now(),c.querySearch_(d,c.provincia_,b)})};M.control.Searchstreet.prototype.querySearch_=function(a,b,c){var d=this;(function(e){M.remote.get(a).then(function(a){if(e===d.searchTime_){var f;try{f=M.utils.isNullOrEmpty(a.text)||-1!=a.text.indexOf("No se ha podido obtener el codigoINE")?null:JSON.parse(a.text)}catch(h){M.exception("La respuesta no es un JSON v\u00e1lido: "+h)}M.utils.isNullOrEmpty(f)||(d.provincia_=M.utils.beautifyString(b));
c.call(d,f);goog.dom.classlist.remove(d.element_,M.control.Searchstreet.SEARCHING_CLASS);goog.dom.classlist.remove(d.resultsContainer_,M.control.Searchstreet.MINIMUM)}})})(this.searchTime_)};M.control.Searchstreet.prototype.querySearchProvinces=function(a,b,c){var d=this;(function(e){M.remote.get(a).then(function(a){d.respuestasProvincias_.push(a);d.contadorProvincias++;if(8==d.contadorProvincias){a=0;for(var f=d.respuestasProvincias_.length;a<f;a++)if(e===d.searchTime_){var h;try{var k=d.respuestasProvincias_[a].text;
h=M.utils.isNullOrEmpty(k)||-1!=k.indexOf("No se ha podido obtener el codigoINE")?null:JSON.parse(k)}catch(l){M.exception("La respuesta no es un JSON v\u00e1lido: "+l)}M.utils.isNullOrEmpty(h)||0===h.geocoderMunProvSrsResponse.geocoderMunProvSrsReturn.geocoderMunProvSrsReturn.coordinateX||(d.provincia_=M.utils.beautifyString(b),c.call(d,h),goog.dom.classlist.remove(d.element_,M.control.Searchstreet.SEARCHING_CLASS),goog.dom.classlist.remove(d.resultsContainer_,M.control.Searchstreet.MINIMUM))}}})})(this.searchTime_)};
M.control.Searchstreet.prototype.showResults_=function(a){var b=this,c=this.parseResultsForTemplate_(a);if(!M.utils.isUndefined(this.codIne_)){a=0;for(var d=c.docs.length;a<d;a++)M.utils.isUndefined(c.docs[a])||void 0!==c.docs[a].coordinateX||(c.docs.splice(a,1),d--,a--)}M.template.compile(M.control.Searchstreet.RESULTS_TEMPLATE,{jsonp:!0,vars:c}).then(function(a){goog.dom.classlist.remove(b.resultsContainer_,M.control.Searchstreet.HIDDEN_RESULTS_CLASS);b.resultsContainer_.innerHTML=a.innerHTML;b.resultsScrollContainer_=
b.resultsContainer_.querySelector("div#m-searchstreet-results-scroll");M.utils.isNullOrEmpty(b.resultsScrollContainer_)||M.utils.enableTouchScroll(b.resultsScrollContainer_);b.facadeMap_.removePopup();0<b.getImpl().listPoints.length&&b.getImpl().removePoints_();M.utils.isUndefined(c.docs[0])||(b.getImpl().drawPoints(c.docs),b.eventList_(c.docs));goog.dom.classlist.remove(b.element_,M.control.Searchstreet.SEARCHING_CLASS);goog.dom.classlist.remove(b.resultsContainer_,M.control.Searchstreet.MINIMUM);
a=b.resultsContainer_.querySelector("div.page > div.g-cartografia-flecha-arriba");goog.events.listen(a,goog.events.EventType.CLICK,b.resultsClick_,!1,b);b.fire(M.evt.COMPLETED)});this.element_.getElementsByTagName("div")["m-autocomplete-results"].innerHTML=""};M.control.Searchstreet.prototype.parseResultsForTemplate_=function(a){var b;b=null;var c=this.input_.value;if(M.utils.isNullOrEmpty(a))b={docs:[void 0],containtResult:b,search:c};else if(a=a.geocoderMunProvSrsResponse.geocoderMunProvSrsReturn,
b=!M.utils.isNullOrEmpty(a),a.geocoderMunProvSrsReturn instanceof Array)if(M.utils.isUndefined(a.geocoderMunProvSrsReturn[0].coordinateX))b={docs:[void 0],containtResult:!1,search:c};else{for(var d=0,e=a.geocoderMunProvSrsReturn.length;d<e;d++)a.geocoderMunProvSrsReturn[d].localityName=this.municipio_,a.geocoderMunProvSrsReturn[d].cityName=this.provincia_,a.geocoderMunProvSrsReturn[d].streetType=M.utils.beautifyString(a.geocoderMunProvSrsReturn[d].streetType),a.geocoderMunProvSrsReturn[d].streetName=
M.utils.beautifyString(a.geocoderMunProvSrsReturn[d].streetName);b={docs:a.geocoderMunProvSrsReturn,containtResult:b,search:c}}else M.utils.isNullOrEmpty(a)?b={docs:[void 0],containtResult:b,search:c}:0===a.geocoderMunProvSrsReturn.coordinateX?b={docs:[void 0],containtResult:!1,search:c}:(a.geocoderMunProvSrsReturn.localityName=this.municipio_,a.geocoderMunProvSrsReturn.cityName=this.provincia_,a.geocoderMunProvSrsReturn.streetType=M.utils.beautifyString(a.geocoderMunProvSrsReturn.streetType),a.geocoderMunProvSrsReturn.streetName=
M.utils.beautifyString(a.geocoderMunProvSrsReturn.streetName),b={docs:[a.geocoderMunProvSrsReturn],containtResult:b,search:c});return b};M.control.Searchstreet.prototype.eventList_=function(a){for(var b=this.resultsContainer_.getElementsByClassName("result"),c=0,d=b.length;c<d;c++)this.addEventClickList_(b[c],a[c])};M.control.Searchstreet.prototype.addEventClickList_=function(a,b){var c=this;goog.events.listen(a,goog.events.EventType.CLICK,function(a){M.window.WIDTH<=M.config.MOBILE_WIDTH&&(a.target=
this.resultsContainer_.querySelector("div.page > div.g-cartografia-flecha-arriba"),this.resultsClick_(a));c.getImpl().addEventClickFeature(b)},!1,this)};M.control.Searchstreet.prototype.equals=function(a){var b=!1;a instanceof M.control.Searchstreet&&(b=this.name===a.name);return b};M.control.Searchstreet.prototype.getInput=function(){return this.input_};M.control.Searchstreet.prototype.getHtml=function(){return this.element_};M.control.Searchstreet.prototype.clearSearchs_=function(){goog.dom.classlist.remove(this.element_,
"shown");this.facadeMap_.removePopup();this.getImpl().removePoints_();this.input_.value="";this.resultsContainer_.innerHTML="";this.resultsAutocomplete_.innerHTML=""};M.control.Searchstreet.prototype.resultsClick_=function(a){goog.dom.classlist.add(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra-search");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-arriba");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsContainer_,
M.control.Searchstreet.HIDDEN_RESULTS_CLASS)};M.control.Searchstreet.TEMPLATE="searchstreet.html";M.control.Searchstreet.RESULTS_TEMPLATE="searchstreetresults.html";M.control.Searchstreet.SEARCHING_CLASS="m-searching";M.control.Searchstreet.HIDDEN_RESULTS_CLASS="hidden";M.control.Searchstreet.MINIMUM="minimum"})();P.impl.control.Searchstreet={};
(function(){M.impl.control.Searchstreet=function(){this.facadeMap_=null;this.listPoints=[];this.element_=null};goog.inherits(M.impl.control.Searchstreet,ol.control.Control);M.impl.control.Searchstreet.prototype.addTo=function(a,b){this.facadeMap_=a;this.element_=b;ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.Searchstreet.prototype.drawPoints=function(a){for(var b,c=0,d=a.length;c<d;c++)b=new ol.Feature,b.setStyle(new ol.style.Style({image:new ol.style.Circle({radius:6,fill:new ol.style.Fill({color:"#3399CC"}),
stroke:new ol.style.Stroke({color:"#fff",width:2})})})),b.setGeometry(new ol.geom.Point([a[c].coordinateX,a[c].coordinateY])),this.addEventClickFeature(a[c],b),this.facadeMap_.drawFeatures([M.impl.Feature.olFeature2Facade(b)]),this.listPoints.push([b]);this.zoomResults()};M.impl.control.Searchstreet.prototype.zoomResults=function(){var a=ol.extent.boundingExtent(this.listPoints[0].filter(function(a){return!M.utils.isNullOrEmpty(a.getGeometry())}).map(function(a){return a.getGeometry().getFirstCoordinate()}));
this.facadeMap_.setBbox(a)};M.impl.control.Searchstreet.prototype.addEventClickFeature=function(a,b){this.facadeMap_.removePopup();var c=this;M.utils.isNullOrEmpty(b)?(this.showPopup_(a,!1),this.facadeMap_.setBbox([a.coordinateX,a.coordinateY,a.coordinateX,a.coordinateY])):b instanceof ol.Feature&&b.set("vendor",{mapea:{click:function(b){c.showPopup_(a)}}})};M.impl.control.Searchstreet.prototype.showPopup_=function(a,b){var c=this;M.template.compile(M.impl.control.Searchstreet.POPUP_TEMPLATE,{jsonp:!0,
vars:{tVia:a.streetType,nVia:a.streetName,num:a.streetNumber,mun:a.localityName,prov:a.cityName},parseToHtml:!1}).then(function(d){d={icon:"g-cartografia-zoom",title:"Searchstreet",content:d};c.popup_=c.facadeMap_.getPopup();M.utils.isNullOrEmpty(c.popup_)?(M.utils.isUndefined(b)?c.popup_=new M.Popup:c.popup_=new M.Popup({panMapIfOutOfView:b}),c.popup_.addTab(d),c.facadeMap_.addPopup(c.popup_,[a.coordinateX,a.coordinateY])):c.popup_.getTabs().some(function(a){return"Searchstreet"!==a.title})?c.popup_.addTab(d):
(c.facadeMap_.removePopup(),M.utils.isUndefined(b)?c.popup_=new M.Popup:c.popup_=new M.Popup({panMapIfOutOfView:b}),c.popup_.addTab(d),c.facadeMap_.addPopup(c.popup_,[a.coordinateX,a.coordinateY]))})};M.impl.control.Searchstreet.prototype.getElement=function(){return this.element_};M.impl.control.Searchstreet.prototype.removePoints_=function(){for(var a=0,b=this.listPoints.length;a<b;a++)this.facadeMap_.removeFeatures(this.listPoints[a].map(M.impl.Feature.olFeature2Facade));this.listPoints=[]};M.impl.control.Searchstreet.prototype.destroy=
function(){goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.removePoints_();this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_.getImpl().removePopup();this.element_=this.listPoints=this.facadeMap_=null};M.impl.control.Searchstreet.POPUP_TEMPLATE="searchstreetpopup.html"})();P.impl.control.GeosearchIntegrated={};(function(){M.impl.control.GeosearchIntegrated=function(){M.impl.control.Geosearch.call(this)};goog.inherits(M.impl.control.GeosearchIntegrated,M.impl.control.Geosearch);M.impl.control.GeosearchIntegrated.prototype.addTo=function(a,b){this.facadeMap_=a;a.addLayers(this.layer_);ol.control.Control.call(this,{element:b,target:null})};M.impl.control.GeosearchIntegrated.prototype.zoomToResults=function(){}})();P.control.GeosearchIntegrated={};
(function(){M.control.GeosearchIntegrated=function(a,b,c,d){M.utils.isUndefined(M.impl.control.GeosearchIntegrated)&&M.exception("La implementaci\u00f3n usada no puede crear controles GeosearchIntegrated");this.impl=new M.impl.control.GeosearchIntegrated;M.control.Geosearch.call(this,a,b,c,d)};goog.inherits(M.control.GeosearchIntegrated,M.control.Geosearch);M.control.GeosearchIntegrated.prototype.createView=function(a,b){this.facadeMap_=b;this.addEvents(a);return null};M.control.GeosearchIntegrated.prototype.addEvents=
function(a){this.element_=a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-searchstreetgeosearch-search-input"];a=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-search-btn"];goog.events.listen(a,goog.events.EventType.CLICK,this.searchClick_,!1,this);var b=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-help-btn"];goog.events.listen(b,goog.events.EventType.CLICK,
function(a){a.preventDefault();goog.dom.classlist.toggle(b,"shown");this.helpClick_()},!1,this);this.resultsContainer_=this.element_.getElementsByTagName("div")["m-geosearch-results"];M.utils.enableTouchScroll(this.resultsContainer_);this.searchingResult_=this.element_.querySelector("div#m-geosearch-results > div#m-searching-result-geosearch")};M.control.GeosearchIntegrated.prototype.appendResults_=function(a){this.drawNewResults(a);var b=this.parseResultsForTemplate_(a,!0),c=this;M.template.compile(M.control.Geosearch.RESULTS_TEMPLATE,
{jsonp:!0,vars:b}).then(function(b){b=b.getElementsByTagName("div")["m-geosearch-results-scroll"].children;for(var d;null!==(d=b.item(0));)c.resultsScrollContainer_.appendChild(d),goog.events.listen(d,goog.events.EventType.CLICK,c.resultClick_,!1,c);c.resultsContainer_.getElementsByTagName("span")["m-geosearch-page-found"].innerHTML=c.results_.length;goog.dom.classlist.remove(c.element_,M.control.Geosearch.SEARCHING_CLASS);c.resultsContainer_.removeChild(c.searchingResult_);c.checkScrollSearch_(a)})};
M.control.GeosearchIntegrated.prototype.resultsClick_=function(a){goog.dom.classlist.toggle(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra-search");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-arriba");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsContainer_,"hidden");M.utils.isNullOrEmpty(this.resultsContainer_.parentElement.querySelector("div#m-searchstreet-results.hidden"))&&goog.dom.classlist.toggle(this.resultsContainer_.parentElement,
"hidden")};M.control.GeosearchIntegrated.prototype.getImpl=function(a){return this.impl}})();P.plugin.SearchstreetGeosearch={};
(function(){M.plugin.SearchstreetGeosearch=function(a){this.parameters_=a=a||{};this.name="searchstreetgeosearch";this.control_=this.map_=null;this.locality_=a.locality;M.Plugin.call(this)};goog.inherits(M.plugin.SearchstreetGeosearch,M.Plugin);M.plugin.SearchstreetGeosearch.prototype.addTo=function(a){this.map_=a;var b=this;this.control_=new M.control.SearchstreetGeosearch(this.parameters_);goog.dom.classlist.add(a._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.control_.on(M.evt.ADDED_TO_MAP,
function(){this.fire(M.evt.ADDED_TO_MAP);var a=M.utils.addParameters(M.config.SEARCHSTREET_URLCOMPROBARINE,{codigo:this.locality_});M.remote.get(a).then(function(a){a=JSON.parse(a.text);M.utils.isNullOrEmpty(a.comprobarCodIneResponse.comprobarCodIneReturn)&&(b.locality_="");a=new M.plugin.Autocomplete({locality:b.locality_,target:b.control_.getInput(),html:b.control_.getHtml()});b.map_.addPlugin(a)})},this);this.panel_=new M.ui.Panel("SearchstreetGeosearch",{collapsible:!0,className:"m-geosearch",
position:M.ui.position.TL,tooltip:"Buscador de calles y geob\u00fasquedas"});b.panel_.on(M.evt.ADDED_TO_MAP,function(a){b.panel_._buttonPanel.addEventListener("click",function(a){b.panel_._collapsed||b.control_.input_.focus()})});this.panel_.addControls(this.control_);this.map_.addPanels(this.panel_)};M.plugin.SearchstreetGeosearch.prototype.destroy=function(){this.map_.removeControls([this.control_]);this.locality_=this.control_=this.map_=this.parameters_=this.name=null};M.plugin.SearchstreetGeosearch.prototype.equals=
function(a){return a instanceof M.plugin.SearchstreetGeosearch?!0:!1}})();P.impl.control.SearchstreetIntegrated={};(function(){M.impl.control.SearchstreetIntegrated=function(){M.impl.control.Searchstreet.call(this)};goog.inherits(M.impl.control.SearchstreetIntegrated,M.impl.control.Searchstreet);M.impl.control.SearchstreetIntegrated.prototype.addTo=function(a,b){this.facadeMap_=a;this.element_=b;ol.control.Control.call(this,{element:b,target:null})};M.impl.control.SearchstreetIntegrated.prototype.zoomResults=function(){}})();P.control.SearchstreetIntegrated={};
(function(){M.control.SearchstreetIntegrated=function(a,b){M.utils.isUndefined(M.impl.control.SearchstreetIntegrated)&&M.exception("La implementaci\u00f3n usada no puede crear controles SearchstreetIntegrated");this.impl=new M.impl.control.SearchstreetIntegrated;M.control.Searchstreet.call(this,a,b)};goog.inherits(M.control.SearchstreetIntegrated,M.control.Searchstreet);M.control.SearchstreetIntegrated.prototype.createView=function(a,b){this.facadeMap_=b;this.addEvents(a);return null};M.control.SearchstreetIntegrated.prototype.addEvents=
function(a){this.element_=a;var b=this;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this);this.input_=this.element_.getElementsByTagName("input")["m-searchstreetgeosearch-search-input"];this.button_=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-search-btn"];this.clear_=this.element_.getElementsByTagName("button")["m-searchstreetgeosearch-clear-btn"];goog.events.listen(this.button_,goog.events.EventType.CLICK,this.searchClick_,!1,this);goog.events.listen(this.clear_,
goog.events.EventType.CLICK,this.clearSearchs_,!1,this);this.resultsContainer_=this.element_.getElementsByTagName("div")["m-searchstreet-results"];this.resultsAutocomplete_=this.element_.getElementsByTagName("div")["m-autocomplete-results"];this.resultsGeosearch_=this.element_.getElementsByTagName("div")["m-geosearch-results"];this.searchingResult_=this.element_.querySelector("div#m-searchstreet-results > div#m-searching-result-searchstreet");if(!M.utils.isUndefined(this.codIne_)){this.searchTime_=
Date.now();var c=M.utils.addParameters(this.searchCodIne_,{codigo:this.codIne_});(function(a){M.remote.get(c).then(function(a){var c;try{M.utils.isNullOrEmpty(a.text)||(c=JSON.parse(a.text),M.utils.isNullOrEmpty(c.comprobarCodIneResponse.comprobarCodIneReturn)?M.dialog.error("El c\u00f3digo del municipio '"+b.codIne_+"' no es v\u00e1lido"):(b.getMunProv_(c),b.element_.getElementsByTagName("span").codIne.innerHTML="B\u00fasquedas en "+b.municipio_+"  ("+b.provincia_+")"))}catch(g){M.exception("La respuesta no es un JSON v\u00e1lido: "+
g)}})})(this.searchTime_)}goog.dom.removeChildren(this.resultsContainer_,this.searchingResult_)};M.control.SearchstreetIntegrated.prototype.clearSearchs_=function(){goog.dom.classlist.remove(this.element_,"shown");for(var a=this.facadeMap_.getControls(),b=0,c=a.length;b<c;b++)"searchstreetgeosearch"===a[b].name_&&a[b].ctrlGeosearch.getImpl().layer_.clear();this.facadeMap_.removePopup();this.getImpl().removePoints_();this.input_.value="";this.resultsContainer_.innerHTML="";this.resultsAutocomplete_.innerHTML=
"";this.resultsGeosearch_.innerHTML=""};M.control.SearchstreetIntegrated.prototype.searchClick_=function(a){a.preventDefault();if(a.type!==goog.events.EventType.KEYUP||13===a.keyCode)if(goog.dom.classlist.remove(this.resultsAutocomplete_,M.control.Searchstreet.MINIMUM),goog.dom.removeChildren(this.resultsAutocomplete_,this.resultsAutocomplete_.querySelector("div#m-searching-result-autocomplete")),a=this.input_.value,!M.utils.isNullOrEmpty(a))if(this.completed=a.length<this.minAutocomplete_?!1:!0,
M.utils.isUndefined(this.codIne_)||M.utils.isNullOrEmpty(this.codIne_))this.search_(a,this.showResults_);else{var b=a.indexOf(",");-1<a.indexOf(",")&&(a=a.substring(0,b));this.search_(a+", "+this.municipio_+" ("+this.provincia_+")",this.showResults_)}};M.control.SearchstreetIntegrated.prototype.resultsClick_=function(a){goog.dom.classlist.add(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra-searchs");goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-arriba");
goog.dom.classlist.toggle(a.target,"g-cartografia-flecha-abajo");goog.dom.classlist.toggle(this.resultsContainer_,"hidden");M.utils.isNullOrEmpty(this.resultsContainer_.parentElement.querySelector("div#m-geosearch-results.hidden"))&&goog.dom.classlist.toggle(this.resultsContainer_.parentElement,"hidden")};M.control.SearchstreetIntegrated.prototype.getImpl=function(){return this.impl}})();P.control.SearchstreetGeosearch={};
(function(){M.control.SearchstreetGeosearch=function(a){M.utils.isUndefined(M.impl.control.SearchstreetGeosearch)&&M.exception("La implementaci\u00f3n usada no puede crear controles SearchStreetGeosearch");a=a||{};M.utils.isNullOrEmpty(a.locality)||(this.locality_=a.locality);this.urlSearchstret_=M.config.SEARCHSTREET_URL;this.urlGeosearch_=M.config.GEOSEARCH_URL;this.coreGeosearch_=M.config.GEOSEARCH_CORE;this.handlerGeosearch_=M.config.GEOSEARCH_HANDLER;this.paramsGeosearch_=a.paramsGeosearch||
{};this.ctrlGeosearch=this.ctrlSearchstreet=this.input_=null;this.name_="searchstreetgeosearch";this.facadeMap_=this.element_=null;a=new M.impl.control.SearchstreetGeosearch;M.Control.call(this,a,this.name_)};goog.inherits(M.control.SearchstreetGeosearch,M.Control);M.control.SearchstreetGeosearch.prototype.addTo=function(a){var b=this,c=this.getImpl();this.facadeMap_=a;var d=this.createView(a);d instanceof Promise&&d.then(function(d){c.addTo(a,d);b.html=d;b.fire(M.evt.ADDED_TO_MAP)});this.on(M.evt.ADDED_TO_MAP,
function(c){M.utils.isUndefined(b.locality_)?b.ctrlSearchstreet=new M.control.SearchstreetIntegrated(b.urlSearchstret_):b.ctrlSearchstreet=new M.control.SearchstreetIntegrated(b.urlSearchstret_,b.locality_);c=b.ctrlSearchstreet.getImpl();b.ctrlSearchstreet.createView(b.html,a);c.addTo(a,b.html);b.ctrlGeosearch=new M.control.GeosearchIntegrated(b.urlGeosearch_,b.coreGeosearch_,b.handlerGeosearch_,b.paramsGeosearch_);c=b.ctrlGeosearch.getImpl();b.ctrlGeosearch.createView(b.html,b.facadeMap_);c.addTo(a,
b.html);var d=!1;b.ctrlSearchstreet.on(M.evt.COMPLETED,function(){!0===d&&(goog.dom.classlist.add(b.element_,"shown"),d=!1,b.zoomResults());d=!0},this);b.ctrlGeosearch.on(M.evt.COMPLETED,function(){!0===d&&(goog.dom.classlist.add(b.element_,"shown"),d=!1,b.zoomResults());d=!0},this)})};M.control.SearchstreetGeosearch.prototype.createView=function(a){var b=this;return new Promise(function(a,d){M.template.compile(M.control.SearchstreetGeosearch.TEMPLATE,{jsonp:!0}).then(function(c){b.element_=c;b.input_=
c.querySelector("input#m-searchstreetgeosearch-search-input");var d=c.querySelector("div#m-searchstreet-results"),e=c.querySelector("div#m-geosearch-results"),h=c.querySelector("ul#m-tabs > li:nth-child(1) > a"),k=c.querySelector("ul#m-tabs > li:nth-child(2) > a");goog.events.listen(h,goog.events.EventType.CLICK,function(a){a.preventDefault();goog.dom.classlist.contains(h,"activated")||(goog.dom.classlist.add(h,"activated"),goog.dom.classlist.remove(k,"activated"),goog.dom.classlist.add(d,"show"),
goog.dom.classlist.remove(e,"show"))},!1,this);goog.events.listen(k,goog.events.EventType.CLICK,function(a){a.preventDefault();goog.dom.classlist.contains(k,"activated")||(goog.dom.classlist.add(k,"activated"),goog.dom.classlist.remove(h,"activated"),goog.dom.classlist.remove(d,"show"),goog.dom.classlist.add(e,"show"))},!1,this);a(c)})})};M.control.SearchstreetGeosearch.prototype.getInput=function(){return this.input_};M.control.SearchstreetGeosearch.prototype.equals=function(a){var b=!1;a instanceof
M.control.SearchstreetGeosearch&&(b=this.name===a.name);return b};M.control.SearchstreetGeosearch.prototype.getHtml=function(){return this.element_};M.control.SearchstreetGeosearch.prototype.zoomResults=function(){this.getImpl().zoomResults()};M.control.SearchstreetGeosearch.TEMPLATE="searchstreetgeosearch.html"})();P.impl.control.SearchstreetGeosearch={};
(function(){M.impl.control.SearchstreetGeosearch=function(){this.element_=this.facadeMap_=null};goog.inherits(M.impl.control.SearchstreetGeosearch,ol.control.Control);M.impl.control.SearchstreetGeosearch.prototype.addTo=function(a,b){this.facadeMap_=a;this.element_=b;ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.SearchstreetGeosearch.prototype.getElement=function(){return this.element_};M.impl.control.SearchstreetGeosearch.prototype.zoomResults=function(){var a=
this.facadeMap_.getControls().find(function(a){return"searchstreetgeosearch"===a.name_}).ctrlGeosearch.getImpl().layer_.getFeaturesExtent();M.utils.isNullOrEmpty(a)||this.facadeMap_.setBbox(a)};M.impl.control.SearchstreetGeosearch.prototype.destroy=function(){goog.dom.classlist.remove(this.facadeMap_._areasContainer.getElementsByClassName("m-top m-right")[0],"top-extra");this.facadeMap_.getMapImpl().removeControl(this);this.facadeMap_.getImpl().removePopup();this.element_=this.facadeMap_=null}})();goog.exportSymbol("M.control.GeosearchIntegrated",M.control.GeosearchIntegrated);goog.exportProperty(M.control.GeosearchIntegrated.prototype,"createView",M.control.GeosearchIntegrated.prototype.createView);goog.exportProperty(M.control.GeosearchIntegrated.prototype,"addEvents",M.control.GeosearchIntegrated.prototype.addEvents);goog.exportProperty(M.control.GeosearchIntegrated.prototype,"getImpl",M.control.GeosearchIntegrated.prototype.getImpl);
goog.exportSymbol("M.impl.control.GeosearchIntegrated",M.impl.control.GeosearchIntegrated);goog.exportProperty(M.impl.control.GeosearchIntegrated.prototype,"addTo",M.impl.control.GeosearchIntegrated.prototype.addTo);goog.exportSymbol("M.plugin.SearchstreetGeosearch",M.plugin.SearchstreetGeosearch);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"name",M.plugin.SearchstreetGeosearch.prototype.name);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"addTo",M.plugin.SearchstreetGeosearch.prototype.addTo);
goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"destroy",M.plugin.SearchstreetGeosearch.prototype.destroy);goog.exportProperty(M.plugin.SearchstreetGeosearch.prototype,"equals",M.plugin.SearchstreetGeosearch.prototype.equals);goog.exportSymbol("M.impl.control.SearchstreetGeosearch",M.impl.control.SearchstreetGeosearch);goog.exportProperty(M.impl.control.SearchstreetGeosearch.prototype,"addTo",M.impl.control.SearchstreetGeosearch.prototype.addTo);
goog.exportProperty(M.impl.control.SearchstreetGeosearch.prototype,"getElement",M.impl.control.SearchstreetGeosearch.prototype.getElement);goog.exportProperty(M.impl.control.SearchstreetGeosearch.prototype,"zoomResults",M.impl.control.SearchstreetGeosearch.prototype.zoomResults);goog.exportProperty(M.impl.control.SearchstreetGeosearch.prototype,"destroy",M.impl.control.SearchstreetGeosearch.prototype.destroy);goog.exportSymbol("M.control.SearchstreetGeosearch",M.control.SearchstreetGeosearch);
goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"ctrlSearchstreet",M.control.SearchstreetGeosearch.prototype.ctrlSearchstreet);goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"ctrlGeosearch",M.control.SearchstreetGeosearch.prototype.ctrlGeosearch);goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"addTo",M.control.SearchstreetGeosearch.prototype.addTo);goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"createView",M.control.SearchstreetGeosearch.prototype.createView);
goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"getInput",M.control.SearchstreetGeosearch.prototype.getInput);goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"equals",M.control.SearchstreetGeosearch.prototype.equals);goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"getHtml",M.control.SearchstreetGeosearch.prototype.getHtml);goog.exportProperty(M.control.SearchstreetGeosearch.prototype,"zoomResults",M.control.SearchstreetGeosearch.prototype.zoomResults);
goog.exportSymbol("M.control.SearchstreetGeosearch.TEMPLATE",M.control.SearchstreetGeosearch.TEMPLATE);goog.exportSymbol("M.impl.control.SearchstreetIntegrated",M.impl.control.SearchstreetIntegrated);goog.exportProperty(M.impl.control.SearchstreetIntegrated.prototype,"addTo",M.impl.control.SearchstreetIntegrated.prototype.addTo);goog.exportProperty(M.impl.control.SearchstreetIntegrated.prototype,"zoomResults",M.impl.control.SearchstreetIntegrated.prototype.zoomResults);
goog.exportSymbol("M.control.SearchstreetIntegrated",M.control.SearchstreetIntegrated);goog.exportProperty(M.control.SearchstreetIntegrated.prototype,"createView",M.control.SearchstreetIntegrated.prototype.createView);goog.exportProperty(M.control.SearchstreetIntegrated.prototype,"addEvents",M.control.SearchstreetIntegrated.prototype.addEvents);goog.exportProperty(M.control.SearchstreetIntegrated.prototype,"getImpl",M.control.SearchstreetIntegrated.prototype.getImpl); })(window.M);
