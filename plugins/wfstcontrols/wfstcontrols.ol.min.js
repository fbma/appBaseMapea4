(function (M) { var $jscomp={scope:{}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(c.get||c.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
...
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,c){var b=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var e=b.length,f=a.length;c=Math.max(0,Math.min(c|0,b.length));for(var g=0;g<f&&c<e;)if(b[c++]!=a[g++])return!1;return g>=f}},"es6-impl","es3");$jscomp.array=$jscomp.array||{};
$jscomp.iteratorFromArray=function(a,b){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var c=0,d={next:function(){if(c<a.length){var e=c++;return{value:b(e,a[e]),done:!1}}d.next=function(){return{done:!0,value:void 0}};return d.next()}};d[Symbol.iterator]=function(){return d};return d};$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6-impl","es3");var COMPILED=!0,goog=goog||{};goog.global=this;
...
goog.events.wrapListener=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)});return a[goog.events.LISTENER_WRAPPER_PROP_]};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);goog.dom.classes.set(a,c.join(" "));return c.length==e};
...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};var P={control:{}};P.control.ClearFeature={};
(function(){M.control.ClearFeature=function(a){M.utils.isUndefined(M.impl.control.ClearFeature)&&M.exception("La implementaci\u00f3n usada no puede crear controles ClearFeature");a=new M.impl.control.ClearFeature(a);M.Control.call(this,a,M.control.ClearFeature.NAME)};goog.inherits(M.control.ClearFeature,M.Control);M.control.ClearFeature.prototype.createView=function(a){return M.template.compile(M.control.ClearFeature.TEMPLATE,{jsonp:!0})};M.control.ClearFeature.prototype.manageActivation=function(a){a=
a.querySelector("button#m-button-clearfeature");goog.events.listen(a,goog.events.EventType.CLICK,this.clear_,!1,this)};M.control.ClearFeature.prototype.equals=function(a){return a instanceof M.control.ClearFeature};M.control.ClearFeature.prototype.clear_=function(a){a.preventDefault();this.getImpl().clear()};M.control.ClearFeature.prototype.setLayer=function(a){this.getImpl().layer_=a};M.control.ClearFeature.NAME="clearfeature";M.control.ClearFeature.TEMPLATE="clearfeature.html"})();P.control.DeleteFeature={};
(function(){M.control.DeleteFeature=function(a){this.name=M.control.DeleteFeature.NAME;M.utils.isUndefined(M.impl.control.DeleteFeature)&&M.exception("La implementaci\u00f3n usada no puede crear controles DeleteFeature");a=new M.impl.control.DeleteFeature(a);M.Control.call(this,a,M.control.DeleteFeature.NAME)};goog.inherits(M.control.DeleteFeature,M.Control);M.control.DeleteFeature.prototype.createView=function(a){return M.template.compile(M.control.DeleteFeature.TEMPLATE,{jsonp:!0})};M.control.DeleteFeature.prototype.getActivationButton=
function(a){return a.querySelector("button#m-button-deletefeature")};M.control.DeleteFeature.prototype.equals=function(a){return a instanceof M.control.DeleteFeature};M.control.DeleteFeature.prototype.setLayer=function(a){this.getImpl().layer_=a};M.control.DeleteFeature.NAME="deletefeature";M.control.DeleteFeature.TEMPLATE="deletefeature.html"})();P.control.DrawFeature={};
(function(){M.control.DrawFeature=function(a){this.name=M.control.DrawFeature.NAME;M.utils.isUndefined(M.impl.control.DrawFeature)&&M.exception("La implementaci\u00f3n usada no puede crear controles DrawFeature");a=new M.impl.control.DrawFeature(a);M.Control.call(this,a,M.control.DrawFeature.NAME)};goog.inherits(M.control.DrawFeature,M.Control);M.control.DrawFeature.prototype.createView=function(a){return M.template.compile(M.control.DrawFeature.TEMPLATE,{jsonp:!0})};M.control.DrawFeature.prototype.getActivationButton=function(a){return a.querySelector("button#m-button-drawfeature")};
M.control.DrawFeature.prototype.equals=function(a){return a instanceof M.control.DrawFeature};M.control.DrawFeature.prototype.setLayer=function(a){this.getImpl().layer_=a};M.control.DrawFeature.NAME="drawfeature";M.control.DrawFeature.TEMPLATE="drawfeature.html"})();P.control.EditAttribute={};
(function(){M.control.EditAttribute=function(a){this.name=M.control.EditAttribute.NAME;M.utils.isUndefined(M.impl.control.EditAttribute)&&M.exception("La implementaci\u00f3n usada no puede crear controles EditAttribute");a=new M.impl.control.EditAttribute(a);M.Control.call(this,a,M.control.EditAttribute.NAME)};goog.inherits(M.control.EditAttribute,M.Control);M.control.EditAttribute.prototype.createView=function(a){return M.template.compile(M.control.EditAttribute.TEMPLATE,{jsonp:!0})};M.control.EditAttribute.prototype.getActivationButton=
function(a){return a.querySelector("button#m-button-editattribute")};M.control.EditAttribute.prototype.equals=function(a){return a instanceof M.control.EditAttribute};M.control.EditAttribute.prototype.setLayer=function(a){this.getImpl().layer_=a};M.control.EditAttribute.NAME="editattribute";M.control.EditAttribute.POPUP_TITLE="Editattribute";M.control.EditAttribute.TEMPLATE="editattribute.html";M.control.EditAttribute.TEMPLATE_POPUP="editattribute_popup.html"})();P.control.ModifyFeature={};
(function(){M.control.ModifyFeature=function(a){this.name=M.control.ModifyFeature.NAME;this.modify=null;M.utils.isUndefined(M.impl.control.ModifyFeature)&&M.exception("La implementaci\u00f3n usada no puede crear controles ModifyFeature");a=new M.impl.control.ModifyFeature(a);M.Control.call(this,a,M.control.ModifyFeature.NAME)};goog.inherits(M.control.ModifyFeature,M.Control);M.control.ModifyFeature.prototype.createView=function(a){return M.template.compile(M.control.ModifyFeature.TEMPLATE,{jsonp:!0})};
M.control.ModifyFeature.prototype.getActivationButton=function(a){return a.querySelector("button#m-button-modifyfeature")};M.control.ModifyFeature.prototype.equals=function(a){return a instanceof M.control.ModifyFeature};M.control.ModifyFeature.prototype.setLayer=function(a){this.getImpl().layer_=a};M.control.ModifyFeature.NAME="modifyfeature";M.control.ModifyFeature.TEMPLATE="modifyfeature.html"})();P.control.SaveFeature={};
(function(){M.control.SaveFeature=function(a){this.name=M.control.SaveFeature.NAME;M.utils.isUndefined(M.impl.control.SaveFeature)&&M.exception("La implementaci\u00f3n usada no puede crear controles SaveFeature");a=new M.impl.control.SaveFeature(a);M.Control.call(this,a,M.control.SaveFeature.NAME)};goog.inherits(M.control.SaveFeature,M.Control);M.control.SaveFeature.prototype.createView=function(a){this.facadeMap_=a;return M.template.compile(M.control.SaveFeature.TEMPLATE,{jsonp:!0})};M.control.SaveFeature.prototype.equals=
function(a){return a instanceof M.control.SaveFeature};M.control.SaveFeature.prototype.manageActivation=function(a){a=a.querySelector("button#m-button-savefeature");goog.events.listen(a,goog.events.EventType.CLICK,this.saveFeature_,!1,this)};M.control.SaveFeature.prototype.saveFeature_=function(a){a.preventDefault();this.getImpl().saveFeature()};M.control.SaveFeature.prototype.setLayer=function(a){this.getImpl().layer_=a};M.control.SaveFeature.NAME="savefeature";M.control.SaveFeature.TEMPLATE="savefeature.html"})();P.plugin={};P.plugin.WFSTControls={};M.plugin.WFSTControls=function(a,b){this.controls=a;this.name=M.plugin.WFSTControls.NAME;this.layername_=b;this.editattibute_=this.savefeature_=this.clearfeature_=this.deletefeature_=this.modifyfeature_=this.drawfeature_=this.map_=null;M.Plugin.call(this)};goog.inherits(M.plugin.WFSTControls,M.Plugin);
M.plugin.WFSTControls.prototype.addTo=function(a){this.map_=a;var b=M.utils.isNullOrEmpty(this.map_.getWFS({name:this.layername_})[0])?this.map_.getWFS()[0]:this.map_.getWFS({name:this.layername_})[0];if(M.utils.isNullOrEmpty(b))M.dialog.error("Los controles <b>"+this.controls.join(",")+"</b> no se pueden a\u00f1adir al mapa porque no existe una capa WFS cargada.");else{for(var c=!1,d=!1,e=0,f=this.controls.length;e<f;e++)"drawfeature"===this.controls[e]?(this.drawfeature_=new M.control.DrawFeature(b),
a.addControls([this.drawfeature_]),d=c=!0):"modifyfeature"===this.controls[e]?(this.modifyfeature_=new M.control.ModifyFeature(b),a.addControls([this.modifyfeature_]),d=c=!0):"deletefeature"===this.controls[e]?(this.deletefeature_=new M.control.DeleteFeature(b),a.addControls([this.deletefeature_]),d=c=!0):"editattribute"===this.controls[e]&&(this.editattibute_=new M.control.EditAttribute(b),a.addControls([this.editattibute_]),d=!0);c&&(this.savefeature_=new M.control.SaveFeature(b),a.addControls([this.savefeature_]));
d&&(this.clearfeature_=new M.control.ClearFeature(b),a.addControls([this.clearfeature_]))}};M.plugin.WFSTControls.prototype.destroy=function(){this.map_.removeControls([this.drawfeature_,this.modifyfeature_,this.deletefeature_,this.clearfeature_,this.savefeature_,this.editattibute_]);this.editattibute_=this.savefeature_=this.clearfeature_=this.deletefeature_=this.modifyfeature_=this.drawfeature_=this.map_=this.controls=null};
M.plugin.WFSTControls.prototype.setLayer=function(a){this.layername_=a;var b=this.map_.getWFS({name:this.layername_})[0];M.utils.isNullOrEmpty(b)?M.dialog.error("Los capa <b>"+a+"</b> no es una capa WFS cargada."):(a=[],M.utils.isNullOrEmpty(this.drawfeature_)||a.push(this.drawfeature_),M.utils.isNullOrEmpty(this.modifyfeature_)||a.push(this.modifyfeature_),M.utils.isNullOrEmpty(this.deletefeature_)||a.push(this.deletefeature_),M.utils.isNullOrEmpty(this.clearfeature_)||a.push(this.clearfeature_),
M.utils.isNullOrEmpty(this.savefeature_)||a.push(this.savefeature_),M.utils.isNullOrEmpty(this.editattibute_)||a.push(this.editattibute_),this.clearfeature_.getImpl().clear(),a.forEach(function(a){a.setLayer(b)}))};M.plugin.WFSTControls.prototype.equals=function(a){return a instanceof M.plugin.WFSTControls?!0:!1};M.plugin.WFSTControls.NAME="wfstcontrols";P.impl={};P.impl.control={};P.impl.control.ClearFeature={};
(function(){M.impl.control.ClearFeature=function(a){this.layer_=a};goog.inherits(M.impl.control.ClearFeature,M.impl.Control);M.impl.control.ClearFeature.prototype.addTo=function(a,b){this.facadeMap_=a;M.impl.control.ClearFeature.superClass_.addTo.call(this,a,b)};M.impl.control.ClearFeature.prototype.clear=function(){var a=this.facadeMap_.getControls("drawfeature")[0];M.utils.isNullOrEmpty(a)||(a.getImpl().modifiedFeatures.length=0,a.deactivate());a=this.facadeMap_.getControls("modifyfeature")[0];
M.utils.isNullOrEmpty(a)||(a.getImpl().modifiedFeatures.length=0,a.deactivate());a=this.facadeMap_.getControls("deletefeature")[0];M.utils.isNullOrEmpty(a)||(a.getImpl().modifiedFeatures.length=0,a.deactivate());a=this.facadeMap_.getControls("editattribute")[0];M.utils.isNullOrEmpty(a)||(a.getImpl().editedFeature=null,a.deactivate());this.layer_.getImpl().refresh(!0)};M.impl.control.ClearFeature.prototype.destroy=function(){this.layer_=null;this.facadeMap_.getMapImpl().removeControl(this)}})();P.impl.control.WFSTBase={};
(function(){M.impl.control.WFSTBase=function(a){this.layer_=a;this.interaction_=null;this.modifiedFeatures=[];M.impl.Control.call(this)};goog.inherits(M.impl.control.WFSTBase,M.impl.Control);M.impl.control.WFSTBase.prototype.addTo=function(a,b){this.facadeMap_=a;ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};M.impl.control.WFSTBase.prototype.activate=function(){M.utils.isNullOrEmpty(this.interaction_)&&(this.createInteraction_(),this.facadeMap_.getMapImpl().addInteraction(this.interaction_));this.interaction_.setActive(!0)};
M.impl.control.WFSTBase.prototype.deactivate=function(){M.utils.isNullOrEmpty(this.interaction_)&&(this.createInteraction_(),this.facadeMap_.getMapImpl().addInteraction(this.interaction_));this.interaction_.setActive(!1)};M.impl.control.WFSTBase.prototype.createInteraction_=function(){};M.impl.control.WFSTBase.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.modifiedFeatures=this.interaction_=this.layer_=null}})();P.impl.control.DeleteFeature={};
(function(){M.impl.control.DeleteFeature=function(a){this.layer_=a;this.modifiedFeatures=[];M.impl.Control.call(this,a)};goog.inherits(M.impl.control.DeleteFeature,M.impl.Control);M.impl.control.DeleteFeature.prototype.activate=function(){this.layer_.on(M.evt.SELECT_FEATURES,this.removeFeature_,this)};M.impl.control.DeleteFeature.prototype.deactivate=function(){this.layer_.un(M.evt.SELECT_FEATURES,this.removeFeature_,this)};M.impl.control.DeleteFeature.prototype.removeFeature_=function(a,b){a=a[0].getImpl().getOLFeature();
this.layer_.getImpl().getOL3Layer().getSource().removeFeature(a);M.utils.isNullOrEmpty(a.getId())?(b=this.facadeMap_.getControls("drawfeature")[0],M.utils.isNullOrEmpty(b)||(b=b.getImpl().modifiedFeatures,a=b.indexOf(a),b.splice(a,1))):this.modifiedFeatures.push(a)}})();P.impl.control.DrawFeature={};
(function(){M.impl.control.DrawFeature=function(a){M.impl.control.WFSTBase.call(this,a)};goog.inherits(M.impl.control.DrawFeature,M.impl.control.WFSTBase);M.impl.control.DrawFeature.prototype.createInteraction_=function(){var a=this.layer_.getImpl().getOL3Layer(),b=a.getStyle()()[0],c=$jscomp.makeIterator([b.getFill(),b.getStroke()]),d=c.next().value,c=c.next().value,e=new ol.style.Circle({fill:d||c,radius:5,stroke:c});b.getImage()&&(e=b.getImage());this.interaction_=new ol.interaction.Draw({source:a.getSource(),
type:M.geom.parseWFS(this.layer_.geometry),style:new ol.style.Style({image:e,fill:d,stroke:c||new ol.style.Stroke({fill:{color:"#000"}})})});this.interaction_.on("drawend",function(a){this.modifiedFeatures.push(a.feature)},this);this.layer_.on(M.evt.LOAD,this.updateLayerFeatures_,this)};M.impl.control.DrawFeature.prototype.updateLayerFeatures_=function(){this.facadeMap_.getMapImpl().removeInteraction(this.interaction_);this.interaction_=null};M.impl.control.DrawFeature.prototype.deactivate=function(){M.utils.isNullOrEmpty(this.interaction_)&&
this.createInteraction_();this.facadeMap_.getMapImpl().removeInteraction(this.interaction_);this.interaction_=null}})();P.impl.control.EditAttribute={};
(function(){M.impl.control.EditAttribute=function(a){this.layer_=a;this.editFeature=null;M.impl.Control.call(this)};goog.inherits(M.impl.control.EditAttribute,M.impl.Control);M.impl.control.EditAttribute.prototype.activate=function(){this.layer_.on(M.evt.SELECT_FEATURES,this.showEditPopup_,this);this.layer_.on(M.evt.UNSELECT_FEATURES,this.unselectFeature_,this)};M.impl.control.EditAttribute.prototype.deactivate=function(){this.layer_.un(M.evt.SELECT_FEATURES,this.showEditPopup_,this);this.layer_.un(M.evt.UNSELECT_FEATURES,
this.unselectFeature_,this)};M.impl.control.EditAttribute.prototype.showEditPopup_=function(a,b){this.unselectFeature_();this.editFeature=a[0].getImpl().getOLFeature();var c=b.coord;if(M.utils.isNullOrEmpty(this.editFeature.getId()))this.editFeature=null,M.dialog.info("Debe guardar el elemento previamente");else{this.editFeature.setStyle(M.impl.control.EditAttribute.SELECTED_STYLE);var d={properties:[]};Object.keys(this.editFeature.getProperties()).filter(function(a){return"geometry"!==a}).forEach(function(a){d.properties.push({key:a,
value:this.editFeature.get(a)})},this);var e=this;M.template.compile(M.control.EditAttribute.TEMPLATE_POPUP,{jsonp:!0,vars:d,parseToHtml:!1}).then(function(a){a={icon:"g-cartografia-texto",title:M.control.EditAttribute.POPUP_TITLE,content:a};e.popup_=e.facadeMap_.getPopup();M.utils.isNullOrEmpty(e.popup_)?(e.popup_=new M.Popup,e.popup_.addTab(a),e.facadeMap_.addPopup(e.popup_,c)):e.popup_.getTabs().some(function(a){return a.title!==M.control.EditAttribute.POPUP_TITLE})?e.popup_.addTab(a):(e.facadeMap_.removePopup(),
e.popup_=new M.Popup,e.popup_.addTab(a),e.facadeMap_.addPopup(e.popup_,c));e.popup_.on(M.evt.SHOW,function(){var a=this.popup_.getContent().querySelector("button#m-button-editattributeSave");M.utils.isNullOrEmpty(a)||goog.events.listen(a,goog.events.EventType.CLICK,this.saveAttributes_,!1,this)},e);e.popup_.on(M.evt.DESTROY,function(){var a=this.popup_.getContent().querySelector("button#m-button-editattributeSave");M.utils.isNullOrEmpty(a)||goog.events.unlisten(a,goog.events.EventType.CLICK,this.saveAttributes_,
!1,this);this.unselectFeature_()},e)})}};M.impl.control.EditAttribute.prototype.saveAttributes_=function(a){this.editFeature.unset("bbox",!0);var b=this.popup_.getContent(),c=a.target;a=this.editFeature.getProperties();goog.dom.classes.add(c,"m-savefeature-saving");Object.keys(a).forEach(function(a){if(null!==b.querySelector("input#"+a)){var c=b.querySelector("input#"+a).value;this.editFeature.set(a,c,!0)}},this);this.layer_.getImpl().getDescribeFeatureType().then(function(a){var b=this.editFeature.getGeometryName(),
d=this.editFeature.getGeometry();this.editFeature.setGeometryName(a.geometryName);this.editFeature.setGeometry(d);this.editFeature.unset(b);b=this.facadeMap_.getProjection().code;a=(new ol.format.WFS).writeTransaction(null,[this.editFeature],null,{featureNS:a.featureNS,featurePrefix:a.featurePrefix,featureType:this.layer_.name,srsName:b,gmlOptions:{srsName:b}});a=goog.dom.xml.serialize(a);this.facadeMap_.removePopup(this.popup_);M.remote.post(this.layer_.url,a).then(function(a){goog.dom.classes.remove(c,
"m-savefeature-saving");200===a.code?M.dialog.success("Se ha guardado correctamente el elemento"):M.dialog.error("Ha ocurrido un error al guardar: ".concat(a.text))})}.bind(this))};M.impl.control.EditAttribute.prototype.unselectFeature_=function(){null!==this.editFeature&&(this.editFeature.setStyle(M.impl.layer.WFS.STYLE),this.editFeature=null,this.facadeMap_.removePopup())};M.impl.control.EditAttribute.prototype.destroy=function(){M.impl.control.EditAttribute.superClass_.destroy.call(this);M.utils.isNull(this.facadeMap_)||
M.utils.isNull(this.facadeMap_.getPopup())||this.facadeMap_.removePopup()};M.impl.control.EditAttribute.SELECTED_STYLE=new ol.style.Style({fill:new ol.style.Fill({color:"rgba(175, 127, 19, 0.2)"}),stroke:new ol.style.Stroke({color:"#af7f13",width:2}),image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"#af7f13"})})})})();P.impl.control.ModifyFeature={};
(function(){M.impl.control.ModifyFeature=function(a){this.layer_=a;this.modify=null;this.modifiedFeatures=[];this.currentFeature_=null};goog.inherits(M.impl.control.ModifyFeature,M.impl.Control);M.impl.control.ModifyFeature.prototype.activate=function(){M.utils.isNullOrEmpty(this.modify)&&this.createInteractionModify_();this.modify.setActive(!0)};M.impl.control.ModifyFeature.prototype.deactivate=function(){M.utils.isNullOrEmpty(this.modify)&&this.createInteractionModify_();this.facadeMap_.getMapImpl().removeInteraction(this.modify);
this.modify=null};M.impl.control.ModifyFeature.prototype.createInteractionModify_=function(){var a=this.facadeMap_.getMapImpl(),b=this.layer_.getImpl().getOL3Layer(),c=b.getStyle()()[0],d=$jscomp.makeIterator([c.getFill(),c.getStroke()]),e=d.next().value,d=d.next().value,f=d.clone();f.setColor(M.utils.getRgba(d.getColor()));e=new ol.style.Circle({fill:e||f,radius:5,stroke:d});c.getImage()&&(e=c.getImage());b=new ol.Collection(b.getSource().getFeatures());b.forEach(function(a){a.on("change",function(a){this.currentFeature_=
a.target},this)},this);this.modify=new ol.interaction.Modify({features:b,deleteCondition:function(a){return ol.events.condition.shiftKeyOnly(a)&&ol.events.condition.singleClick(a)},style:new ol.style.Style({image:e})});this.modify.on("modifyend",function(a){a=this.modifiedFeatures.indexOf(this.currentFeature_);0<=a?this.modifiedFeatures[a]=this.currentFeature_:this.modifiedFeatures.push(this.currentFeature_);this.currentFeature_=null},this);a.addInteraction(this.modify);this.layer_.on(M.evt.LOAD,
this.updateLayerFeatures_,this)};M.impl.control.ModifyFeature.prototype.updateLayerFeatures_=function(){this.facadeMap_.getMapImpl().removeInteraction(this.modify);this.modify=null};M.impl.control.ModifyFeature.prototype.destroy=function(){this.facadeMap_.getMapImpl().removeControl(this);this.modify=this.layer_=null;this.modifiedFeatures=[]}})();goog.dom.xml={};goog.dom.xml.MAX_XML_SIZE_KB=2048;goog.dom.xml.MAX_ELEMENT_DEPTH=256;goog.dom.xml.hasActiveXObjectSupport_=function(){if(!goog.userAgent.IE)return!1;try{return new ActiveXObject("MSXML2.DOMDocument"),!0}catch(a){return!1}};goog.dom.xml.ACTIVEX_SUPPORT=goog.userAgent.IE&&goog.dom.xml.hasActiveXObjectSupport_();
...
goog.dom.xml.selectNodes=function(a,b){if("undefined"!=typeof a.selectNodes){var c=goog.dom.getOwnerDocument(a);"undefined"!=typeof c.setProperty&&c.setProperty("SelectionLanguage","XPath");return a.selectNodes(b)}if(document.implementation.hasFeature("XPath","3.0")){var c=goog.dom.getOwnerDocument(a),d=c.createNSResolver(c.documentElement);a=c.evaluate(b,a,d,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null);b=[];c=a.snapshotLength;for(d=0;d<c;d++)b.push(a.snapshotItem(d));return b}return[]};
goog.dom.xml.setAttributes=function(a,b){for(var c in b)b.hasOwnProperty(c)&&a.setAttribute(c,b[c])};goog.dom.xml.createMsXmlDocument_=function(){var a=new ActiveXObject("MSXML2.DOMDocument");a.resolveExternals=!1;a.validateOnParse=!1;try{a.setProperty("ProhibitDTD",!0),a.setProperty("MaxXMLSize",goog.dom.xml.MAX_XML_SIZE_KB),a.setProperty("MaxElementDepth",goog.dom.xml.MAX_ELEMENT_DEPTH)}catch(b){}return a};P.impl.control.SaveFeature={};
(function(){M.impl.control.SaveFeature=function(a){this.layer_=a};goog.inherits(M.impl.control.SaveFeature,M.impl.Control);M.impl.control.SaveFeature.prototype.addTo=function(a,b){this.facadeMap_=a;M.impl.control.SaveFeature.superClass_.addTo.call(this,a,b)};M.impl.control.SaveFeature.prototype.saveFeature=function(){this.layer_.getImpl().getDescribeFeatureType().then(function(a){var b=null,c=null,d=null,e=this.facadeMap_.getControls(M.control.DrawFeature.NAME)[0];M.utils.isNullOrEmpty(e)||(b=e.getImpl().modifiedFeatures,
M.impl.control.SaveFeature.applyDescribeFeatureType.bind(this)(b,a));e=this.facadeMap_.getControls(M.control.ModifyFeature.NAME)[0];M.utils.isNullOrEmpty(e)||(c=e.getImpl().modifiedFeatures,M.impl.control.SaveFeature.applyDescribeFeatureType.bind(this)(c,a));e=this.facadeMap_.getControls(M.control.DeleteFeature.NAME)[0];M.utils.isNullOrEmpty(e)||(d=e.getImpl().modifiedFeatures,M.impl.control.SaveFeature.applyDescribeFeatureType.bind(this)(d,a));M.utils.isNullOrEmpty(c)||c.forEach(function(a){a.unset("bbox")});
M.utils.isNullOrEmpty(b)||b.forEach(function(a){a.unset("bbox")});e=this.facadeMap_.getProjection().code;a=(new ol.format.WFS).writeTransaction(b,c,d,{featureNS:a.featureNS,featurePrefix:a.featurePrefix,featureType:this.layer_.name,srsName:e,gmlOptions:{srsName:e}});a=goog.dom.xml.serialize(a);M.remote.post(this.layer_.url,a).then(function(a){this.facadeMap_.getControls(M.control.ClearFeature.NAME)[0].getImpl().clear();200===a.code&&-1===a.text.indexOf("ExceptionText")&&-1===a.text.indexOf("<error><descripcion>")?
M.dialog.success("Se ha guardado correctamente"):401===a.code?M.dialog.error("Ha ocurrido un error al guardar: Usuario no autorizado"):M.dialog.error("Ha ocurrido un error al guardar: ".concat(a.text))}.bind(this))}.bind(this))};M.impl.control.SaveFeature.prototype.destroy=function(){this.layer_=null;this.facadeMap_.getMapImpl().removeControl(this)};M.impl.control.SaveFeature.applyDescribeFeatureType=function(a,b){var c=this.layer_.getImpl();a.forEach(function(a){var d=a.getGeometryName(),f=a.getGeometry();
a.set(b.geometryName,f);a.setGeometryName(b.geometryName);a.setGeometry(f);a.unset(d);b.properties.forEach(function(b){M.utils.isGeometryType(b.localType)||a.set(b.name,c.getDefaultValue(b.localType))})})}})();goog.exportSymbol("M.control.ClearFeature",M.control.ClearFeature);goog.exportProperty(M.control.ClearFeature.prototype,"createView",M.control.ClearFeature.prototype.createView);goog.exportProperty(M.control.ClearFeature.prototype,"manageActivation",M.control.ClearFeature.prototype.manageActivation);goog.exportProperty(M.control.ClearFeature.prototype,"equals",M.control.ClearFeature.prototype.equals);goog.exportProperty(M.control.ClearFeature.prototype,"setLayer",M.control.ClearFeature.prototype.setLayer);
goog.exportSymbol("M.control.ClearFeature.NAME",M.control.ClearFeature.NAME);goog.exportSymbol("M.control.ClearFeature.TEMPLATE",M.control.ClearFeature.TEMPLATE);goog.exportSymbol("M.impl.control.ClearFeature",M.impl.control.ClearFeature);goog.exportProperty(M.impl.control.ClearFeature.prototype,"addTo",M.impl.control.ClearFeature.prototype.addTo);goog.exportProperty(M.impl.control.ClearFeature.prototype,"clear",M.impl.control.ClearFeature.prototype.clear);
goog.exportProperty(M.impl.control.ClearFeature.prototype,"destroy",M.impl.control.ClearFeature.prototype.destroy);goog.exportSymbol("M.control.DeleteFeature",M.control.DeleteFeature);goog.exportProperty(M.control.DeleteFeature.prototype,"createView",M.control.DeleteFeature.prototype.createView);goog.exportProperty(M.control.DeleteFeature.prototype,"getActivationButton",M.control.DeleteFeature.prototype.getActivationButton);goog.exportProperty(M.control.DeleteFeature.prototype,"equals",M.control.DeleteFeature.prototype.equals);
goog.exportProperty(M.control.DeleteFeature.prototype,"setLayer",M.control.DeleteFeature.prototype.setLayer);goog.exportSymbol("M.control.DeleteFeature.NAME",M.control.DeleteFeature.NAME);goog.exportSymbol("M.control.DeleteFeature.TEMPLATE",M.control.DeleteFeature.TEMPLATE);goog.exportSymbol("M.impl.control.DeleteFeature",M.impl.control.DeleteFeature);goog.exportProperty(M.impl.control.DeleteFeature.prototype,"modifiedFeatures",M.impl.control.DeleteFeature.prototype.modifiedFeatures);
goog.exportProperty(M.impl.control.DeleteFeature.prototype,"activate",M.impl.control.DeleteFeature.prototype.activate);goog.exportProperty(M.impl.control.DeleteFeature.prototype,"deactivate",M.impl.control.DeleteFeature.prototype.deactivate);goog.exportSymbol("M.control.DrawFeature",M.control.DrawFeature);goog.exportProperty(M.control.DrawFeature.prototype,"createView",M.control.DrawFeature.prototype.createView);goog.exportProperty(M.control.DrawFeature.prototype,"getActivationButton",M.control.DrawFeature.prototype.getActivationButton);
goog.exportProperty(M.control.DrawFeature.prototype,"equals",M.control.DrawFeature.prototype.equals);goog.exportProperty(M.control.DrawFeature.prototype,"setLayer",M.control.DrawFeature.prototype.setLayer);goog.exportSymbol("M.control.DrawFeature.NAME",M.control.DrawFeature.NAME);goog.exportSymbol("M.control.DrawFeature.TEMPLATE",M.control.DrawFeature.TEMPLATE);goog.exportSymbol("M.impl.control.DrawFeature",M.impl.control.DrawFeature);
goog.exportProperty(M.impl.control.DrawFeature.prototype,"createInteraction_",M.impl.control.DrawFeature.prototype.createInteraction_);goog.exportProperty(M.impl.control.DrawFeature.prototype,"deactivate",M.impl.control.DrawFeature.prototype.deactivate);goog.exportSymbol("M.control.EditAttribute",M.control.EditAttribute);goog.exportProperty(M.control.EditAttribute.prototype,"createView",M.control.EditAttribute.prototype.createView);
goog.exportProperty(M.control.EditAttribute.prototype,"getActivationButton",M.control.EditAttribute.prototype.getActivationButton);goog.exportProperty(M.control.EditAttribute.prototype,"equals",M.control.EditAttribute.prototype.equals);goog.exportProperty(M.control.EditAttribute.prototype,"setLayer",M.control.EditAttribute.prototype.setLayer);goog.exportSymbol("M.control.EditAttribute.NAME",M.control.EditAttribute.NAME);goog.exportSymbol("M.control.EditAttribute.POPUP_TITLE",M.control.EditAttribute.POPUP_TITLE);
goog.exportSymbol("M.control.EditAttribute.TEMPLATE",M.control.EditAttribute.TEMPLATE);goog.exportSymbol("M.control.EditAttribute.TEMPLATE_POPUP",M.control.EditAttribute.TEMPLATE_POPUP);goog.exportSymbol("M.impl.control.EditAttribute",M.impl.control.EditAttribute);goog.exportProperty(M.impl.control.EditAttribute.prototype,"editFeature",M.impl.control.EditAttribute.prototype.editFeature);goog.exportProperty(M.impl.control.EditAttribute.prototype,"activate",M.impl.control.EditAttribute.prototype.activate);
goog.exportProperty(M.impl.control.EditAttribute.prototype,"deactivate",M.impl.control.EditAttribute.prototype.deactivate);goog.exportProperty(M.impl.control.EditAttribute.prototype,"saveAttributes_",M.impl.control.EditAttribute.prototype.saveAttributes_);goog.exportProperty(M.impl.control.EditAttribute.prototype,"unselectFeature_",M.impl.control.EditAttribute.prototype.unselectFeature_);goog.exportProperty(M.impl.control.EditAttribute.prototype,"destroy",M.impl.control.EditAttribute.prototype.destroy);
goog.exportSymbol("M.impl.control.EditAttribute.SELECTED_STYLE",M.impl.control.EditAttribute.SELECTED_STYLE);goog.exportSymbol("M.control.ModifyFeature",M.control.ModifyFeature);goog.exportProperty(M.control.ModifyFeature.prototype,"createView",M.control.ModifyFeature.prototype.createView);goog.exportProperty(M.control.ModifyFeature.prototype,"getActivationButton",M.control.ModifyFeature.prototype.getActivationButton);goog.exportProperty(M.control.ModifyFeature.prototype,"equals",M.control.ModifyFeature.prototype.equals);
goog.exportProperty(M.control.ModifyFeature.prototype,"setLayer",M.control.ModifyFeature.prototype.setLayer);goog.exportSymbol("M.control.ModifyFeature.NAME",M.control.ModifyFeature.NAME);goog.exportSymbol("M.control.ModifyFeature.TEMPLATE",M.control.ModifyFeature.TEMPLATE);goog.exportSymbol("M.impl.control.ModifyFeature",M.impl.control.ModifyFeature);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"modify",M.impl.control.ModifyFeature.prototype.modify);
goog.exportProperty(M.impl.control.ModifyFeature.prototype,"modifiedFeatures",M.impl.control.ModifyFeature.prototype.modifiedFeatures);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"activate",M.impl.control.ModifyFeature.prototype.activate);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"deactivate",M.impl.control.ModifyFeature.prototype.deactivate);goog.exportProperty(M.impl.control.ModifyFeature.prototype,"destroy",M.impl.control.ModifyFeature.prototype.destroy);
goog.exportSymbol("M.control.SaveFeature",M.control.SaveFeature);goog.exportProperty(M.control.SaveFeature.prototype,"createView",M.control.SaveFeature.prototype.createView);goog.exportProperty(M.control.SaveFeature.prototype,"equals",M.control.SaveFeature.prototype.equals);goog.exportProperty(M.control.SaveFeature.prototype,"manageActivation",M.control.SaveFeature.prototype.manageActivation);goog.exportProperty(M.control.SaveFeature.prototype,"saveFeature_",M.control.SaveFeature.prototype.saveFeature_);
goog.exportProperty(M.control.SaveFeature.prototype,"setLayer",M.control.SaveFeature.prototype.setLayer);goog.exportSymbol("M.control.SaveFeature.NAME",M.control.SaveFeature.NAME);goog.exportSymbol("M.control.SaveFeature.TEMPLATE",M.control.SaveFeature.TEMPLATE);goog.exportSymbol("M.impl.control.SaveFeature",M.impl.control.SaveFeature);goog.exportProperty(M.impl.control.SaveFeature.prototype,"addTo",M.impl.control.SaveFeature.prototype.addTo);
goog.exportProperty(M.impl.control.SaveFeature.prototype,"saveFeature",M.impl.control.SaveFeature.prototype.saveFeature);goog.exportProperty(M.impl.control.SaveFeature.prototype,"destroy",M.impl.control.SaveFeature.prototype.destroy);goog.exportSymbol("M.impl.control.SaveFeature.applyDescribeFeatureType",M.impl.control.SaveFeature.applyDescribeFeatureType);goog.exportSymbol("M.plugin.WFSTControls",M.plugin.WFSTControls);goog.exportProperty(M.plugin.WFSTControls.prototype,"name",M.plugin.WFSTControls.prototype.name);
goog.exportProperty(M.plugin.WFSTControls.prototype,"addTo",M.plugin.WFSTControls.prototype.addTo);goog.exportProperty(M.plugin.WFSTControls.prototype,"destroy",M.plugin.WFSTControls.prototype.destroy);goog.exportProperty(M.plugin.WFSTControls.prototype,"setLayer",M.plugin.WFSTControls.prototype.setLayer);goog.exportProperty(M.plugin.WFSTControls.prototype,"equals",M.plugin.WFSTControls.prototype.equals);goog.exportSymbol("M.plugin.WFSTControls.NAME",M.plugin.WFSTControls.NAME);
goog.exportSymbol("M.impl.control.WFSTBase",M.impl.control.WFSTBase);goog.exportProperty(M.impl.control.WFSTBase.prototype,"modifiedFeatures",M.impl.control.WFSTBase.prototype.modifiedFeatures);goog.exportProperty(M.impl.control.WFSTBase.prototype,"addTo",M.impl.control.WFSTBase.prototype.addTo);goog.exportProperty(M.impl.control.WFSTBase.prototype,"activate",M.impl.control.WFSTBase.prototype.activate);goog.exportProperty(M.impl.control.WFSTBase.prototype,"deactivate",M.impl.control.WFSTBase.prototype.deactivate);
goog.exportProperty(M.impl.control.WFSTBase.prototype,"destroy",M.impl.control.WFSTBase.prototype.destroy);goog.exportProperty(M.impl.control.DrawFeature.prototype,"modifiedFeatures",M.impl.control.DrawFeature.prototype.modifiedFeatures);goog.exportProperty(M.impl.control.DrawFeature.prototype,"addTo",M.impl.control.DrawFeature.prototype.addTo);goog.exportProperty(M.impl.control.DrawFeature.prototype,"activate",M.impl.control.DrawFeature.prototype.activate);
goog.exportProperty(M.impl.control.DrawFeature.prototype,"destroy",M.impl.control.DrawFeature.prototype.destroy); })(window.M);
