...
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,c){var b=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var e=b.length,f=a.length;c=Math.max(0,Math.min(c|0,b.length));for(var g=0;g<f&&c<e;)if(b[c++]!=a[g++])return!1;return g>=f}},"es6-impl","es3");var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};
...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};var P={control:{}};P.control.Measure={};M.control.Measure=function(a,b){this.template_=b;M.Control.call(this,a,M.control.Measure.NAME)};goog.inherits(M.control.Measure,M.Control);M.control.Measure.prototype.createView=function(a){return M.template.compile(this.template_,{jsonp:!0})};M.control.Measure.prototype.getActivationButton=function(a){return a.querySelector("button#m-measure-button")};goog.exportProperty(M.control.Measure.prototype,"getActivationButton",M.control.Measure.prototype.getActivationButton);
M.control.Measure.prototype.equals=function(a){var b=!1;a instanceof M.control.Measure&&(b=this.name===a.name);return b};M.control.Measure.prototype.destroy=function(){this.getImpl().destroy();this.impl=this.template_=null};M.control.Measure.NAME="measurebar";M.control.Measure.POINTER_TOOLTIP_TEMPLATE="measure_pointer_tooltip.html";M.control.Measure.MEASURE_TOOLTIP_TEMPLATE="measure_tooltip.html";M.control.Measure.HELP_MESSAGE="Click para empezar a dibujar";P.control.MeasureArea={};M.control.MeasureArea=function(){M.utils.isUndefined(M.impl.control.MeasureArea)&&M.exception("La implementaci\u00f3n usada no puede crear controles MeasureArea");var a=new M.impl.control.MeasureArea;M.control.Measure.call(this,a,M.control.MeasureArea.TEMPLATE)};goog.inherits(M.control.MeasureArea,M.control.Measure);M.control.MeasureArea.prototype.equals=function(a){var b=!1;a instanceof M.control.MeasureArea&&(b=this.name===a.name);return b};
M.control.MeasureArea.TEMPLATE="measurearea.html";M.control.MeasureArea.HELP_KEEP_MESSAGE="Click para continuar dibujando el \u00e1rea";P.control.MeasureLength={};M.control.MeasureLength=function(){M.utils.isUndefined(M.impl.control.MeasureLength)&&M.exception("La implementaci\u00f3n usada no puede crear controles MeasureLength");var a=new M.impl.control.MeasureLength;M.control.Measure.call(this,a,M.control.MeasureLength.TEMPLATE)};goog.inherits(M.control.MeasureLength,M.control.Measure);M.control.MeasureLength.prototype.equals=function(a){var b=!1;a instanceof M.control.MeasureLength&&(b=this.name===a.name);return b};
M.control.MeasureLength.TEMPLATE="measurelength.html";M.control.MeasureLength.HELP_KEEP_MESSAGE="Click para continuar dibujando la l\u00ednea";P.control.MeasureClear={};M.control.MeasureClear=function(a,b){M.utils.isUndefined(M.impl.control.MeasureClear)&&M.exception("La implementaci\u00f3n usada no puede crear controles MeasureClear");a=new M.impl.control.MeasureClear(a.getImpl(),b.getImpl());M.Control.call(this,a,M.control.MeasureClear.NAME)};goog.inherits(M.control.MeasureClear,M.Control);M.control.MeasureClear.prototype.createView=function(a){return M.template.compile(M.control.MeasureClear.TEMPLATE,{jsonp:!0})};
M.control.MeasureClear.prototype.equals=function(a){var b=!1;a instanceof M.control.MeasureClear&&(b=this.name===a.name);return b};M.control.MeasureClear.prototype.destroy=function(){this.getImpl().destroy();this.impl=null};M.control.MeasureClear.NAME="measurebar";M.control.MeasureClear.TEMPLATE="measureclear.html";P.plugin={};P.plugin.Measurebar={};M.plugin.Measurebar=function(){this.measureArea_=this.measureLength_=this.map_=null;this.name=M.plugin.Measurebar.NAME;this.measureClear_=null;M.Plugin.call(this)};goog.inherits(M.plugin.Measurebar,M.Plugin);
M.plugin.Measurebar.prototype.addTo=function(a){this.map_=a;this.measureLength_=new M.control.MeasureLength;this.measureArea_=new M.control.MeasureArea;this.measureClear_=new M.control.MeasureClear(this.measureLength_,this.measureArea_);a.addControls([this.measureLength_,this.measureArea_,this.measureClear_])};
M.plugin.Measurebar.prototype.destroy=function(){this.map_.removeControls([this.measureLength_,this.measureArea_,this.measureClear_]);this.name=this.measureClear_=this.measureArea_=this.measureLength_=this.map_=null};M.plugin.Measurebar.prototype.equals=function(a){return a instanceof M.plugin.Measurebar?!0:!1};M.plugin.Measurebar.NAME="measurebar";P.impl={};P.impl.control={};P.impl.control.Measure={};M.impl.control.Measure=function(a){this.type_=a;this.layer_=this.createLayer_();this.draw_=this.createIteractionDraw_();this.tooltipCoord_=this.currentFeature_=this.facadeMap_=this.measureTooltip_=this.helpTooltip_=null;this.overlays_=[];M.impl.Control.call(this)};goog.inherits(M.impl.control.Measure,M.impl.Control);
M.impl.control.Measure.prototype.addTo=function(a,b){this.facadeMap_=a;a.getMapImpl().addLayer(this.layer_);M.impl.control.Measure.superClass_.addTo.call(this,a,b);this.createHelpTooltip_();this.createMeasureTooltip_()};
M.impl.control.Measure.prototype.activate=function(){if(this instanceof M.impl.control.MeasureLength){var a=this.facadeMap_.getControls().filter(function(a){return a instanceof M.control.MeasureArea})[0];a&&a.deactivate()}else this instanceof M.impl.control.MeasureArea&&(a=this.facadeMap_.getControls().filter(function(a){return a instanceof M.control.MeasureLength})[0])&&a.deactivate();this.createHelpTooltip_().then(function(){this.facadeMap_.getMapImpl().on("pointermove",this.pointerMoveHandler_,
this);this.facadeMap_.getMapImpl().addInteraction(this.draw_);this.active=!0}.bind(this));this.createMeasureTooltip_()};
M.impl.control.Measure.prototype.deactivate=function(){this.facadeMap_.getMapImpl().un("pointermove",this.pointerMoveHandler_,this);this.facadeMap_.getMapImpl().removeInteraction(this.draw_);this.clear();M.utils.isNullOrEmpty(this.helpTooltip_)||this.facadeMap_.getMapImpl().removeOverlay(this.helpTooltip_);M.utils.isNullOrEmpty(this.measureTooltip_)||this.facadeMap_.getMapImpl().removeOverlay(this.measureTooltip_);this.active=!1};
M.impl.control.Measure.prototype.createLayer_=function(){return new ol.layer.Vector({source:new ol.source.Vector({}),style:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(51, 124, 235, 0.2)"}),stroke:new ol.style.Stroke({color:"#337ceb",width:2}),image:new ol.style.Circle({radius:7,fill:new ol.style.Fill({color:"#337ceb"})})}),zIndex:M.impl.Map.Z_INDEX[M.layer.type.WFS]+99})};
M.impl.control.Measure.prototype.createIteractionDraw_=function(){var a=new ol.interaction.Draw({source:this.layer_.getSource(),type:this.type_,style:new ol.style.Style({fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.5)"}),stroke:new ol.style.Stroke({color:"#b54d01",lineDash:[10,10],width:2}),image:new ol.style.Circle({radius:5,stroke:new ol.style.Stroke({color:"#b54d01"}),fill:new ol.style.Fill({color:"rgba(255, 255, 255, 0.5)"})})})});a.on("drawstart",this.onDrawStart_,this);a.on("drawend",
this.onDrawEnd_,this);return a};M.impl.control.Measure.prototype.createHelpTooltip_=function(){var a=this;return M.template.compile(M.control.Measure.POINTER_TOOLTIP_TEMPLATE,{jsonp:!0}).then(function(b){a.helpTooltip_=new ol.Overlay({element:b,offset:[15,0],positioning:"center-left"});a.facadeMap_.getMapImpl().addOverlay(a.helpTooltip_)})};
M.impl.control.Measure.prototype.createMeasureTooltip_=function(){var a=this;M.template.compile(M.control.Measure.MEASURE_TOOLTIP_TEMPLATE,{jsonp:!0}).then(function(b){M.utils.isNullOrEmpty(a.measureTooltip_)||a.overlays_.push(a.measureTooltip_);a.measureTooltip_=new ol.Overlay({element:b,offset:[0,-15],positioning:"bottom-center"});a.facadeMap_.getMapImpl().addOverlay(a.measureTooltip_)})};
M.impl.control.Measure.prototype.onDrawStart_=function(a){this.currentFeature_=a.feature;this.tooltipCoord_=a.coordinate;this.currentFeature_.getGeometry().on("change",this.onGeometryChange_,this)};M.impl.control.Measure.prototype.onDrawEnd_=function(a){this.currentFeature_.getGeometry().un("change",this.onGeometryChange_);this.currentFeature_=null;goog.dom.classes.add(this.measureTooltip_.getElement(),"static");this.measureTooltip_.setOffset([0,-7]);this.createMeasureTooltip_()};
M.impl.control.Measure.prototype.pointerMoveHandler_=function(a){if(!a.dragging){var b=this.helpMsg_;this.currentFeature_&&(b=this.helpMsgContinue_);M.utils.isNullOrEmpty(this.helpTooltip_)||(this.helpTooltip_.getElement().innerHTML=b,this.helpTooltip_.setPosition(a.coordinate))}};
M.impl.control.Measure.prototype.onGeometryChange_=function(a){var b=a.target;a=this.formatGeometry(b);b=this.getTooltipCoordinate(b);M.utils.isNullOrEmpty(this.measureTooltip_)||(this.measureTooltip_.getElement().innerHTML=a,this.measureTooltip_.setPosition(b))};M.impl.control.Measure.prototype.clear=function(){M.utils.isNullOrEmpty(this.layer_)||this.layer_.getSource().clear();this.overlays_.forEach(function(a){this.facadeMap_.getMapImpl().removeOverlay(a)},this);this.overlays_.length=0};
M.impl.control.Measure.prototype.destroy=function(){this.deactivate();this.element.remove();this.facadeMap_.removeControls(this);this.facadeMap_=null;this.overlays_.length=0};P.impl.control.MeasureArea={};M.impl.control.MeasureArea=function(){this.helpMsg_=M.control.Measure.HELP_MESSAGE;this.helpMsgContinue_=M.control.MeasureArea.HELP_KEEP_MESSAGE;M.impl.control.Measure.call(this,"Polygon")};goog.inherits(M.impl.control.MeasureArea,M.impl.control.Measure);M.impl.control.MeasureArea.prototype.formatGeometry=function(a){a=a.getArea();return 1E4<a?Math.round(a/1E6*100)/100+" km<sup>2</sup>":Math.round(100*a)/100+" m<sup>2</sup>"};
M.impl.control.MeasureArea.prototype.getTooltipCoordinate=function(a){return a.getInteriorPoint().getCoordinates()};P.impl.control.MeasureLength={};M.impl.control.MeasureLength=function(){this.helpMsg_=M.control.Measure.HELP_MESSAGE;this.helpMsgContinue_=M.control.MeasureLength.HELP_KEEP_MESSAGE;M.impl.control.Measure.call(this,"LineString")};goog.inherits(M.impl.control.MeasureLength,M.impl.control.Measure);M.impl.control.MeasureLength.prototype.formatGeometry=function(a){a=Math.round(100*a.getLength())/100;return 100<a?Math.round(a/1E3*100)/100+" km":Math.round(100*a)/100+" m"};
M.impl.control.MeasureLength.prototype.getTooltipCoordinate=function(a){return a.getLastCoordinate()};P.impl.control.MeasureClear={};M.impl.control.MeasureClear=function(a,b){this.measureLengthControl_=a;this.facadeMap_=null;this.measureAreaControl_=b};goog.inherits(M.impl.control.MeasureClear,M.impl.Control);M.impl.control.MeasureClear.prototype.addTo=function(a,b){this.facadeMap_=a;var c=b.getElementsByTagName("button")["m-measure-button"];goog.events.listen(c,goog.events.EventType.CLICK,this.onClick,!1,this);ol.control.Control.call(this,{element:b,target:null});a.getMapImpl().addControl(this)};
M.impl.control.MeasureClear.prototype.onClick=function(){M.utils.isNullOrEmpty(this.measureLengthControl_)||this.measureLengthControl_.clear();M.utils.isNullOrEmpty(this.measureAreaControl_)||this.measureAreaControl_.clear()};M.impl.control.MeasureClear.prototype.destroy=function(){this.element.remove();this.facadeMap_.removeControls(this);this.facadeMap_=null};goog.exportSymbol("M.impl.control.MeasureArea",M.impl.control.MeasureArea);goog.exportProperty(M.impl.control.MeasureArea.prototype,"formatGeometry",M.impl.control.MeasureArea.prototype.formatGeometry);goog.exportProperty(M.impl.control.MeasureArea.prototype,"getTooltipCoordinate",M.impl.control.MeasureArea.prototype.getTooltipCoordinate);goog.exportSymbol("M.control.MeasureArea",M.control.MeasureArea);goog.exportProperty(M.control.MeasureArea.prototype,"equals",M.control.MeasureArea.prototype.equals);
goog.exportSymbol("M.control.MeasureArea.TEMPLATE",M.control.MeasureArea.TEMPLATE);goog.exportSymbol("M.control.MeasureArea.HELP_KEEP_MESSAGE",M.control.MeasureArea.HELP_KEEP_MESSAGE);goog.exportSymbol("M.plugin.Measurebar",M.plugin.Measurebar);goog.exportProperty(M.plugin.Measurebar.prototype,"name",M.plugin.Measurebar.prototype.name);goog.exportProperty(M.plugin.Measurebar.prototype,"addTo",M.plugin.Measurebar.prototype.addTo);goog.exportProperty(M.plugin.Measurebar.prototype,"destroy",M.plugin.Measurebar.prototype.destroy);
goog.exportProperty(M.plugin.Measurebar.prototype,"equals",M.plugin.Measurebar.prototype.equals);goog.exportSymbol("M.impl.control.Measure",M.impl.control.Measure);goog.exportProperty(M.impl.control.Measure.prototype,"addTo",M.impl.control.Measure.prototype.addTo);goog.exportProperty(M.impl.control.Measure.prototype,"activate",M.impl.control.Measure.prototype.activate);goog.exportProperty(M.impl.control.Measure.prototype,"deactivate",M.impl.control.Measure.prototype.deactivate);
goog.exportProperty(M.impl.control.Measure.prototype,"clear",M.impl.control.Measure.prototype.clear);goog.exportProperty(M.impl.control.Measure.prototype,"destroy",M.impl.control.Measure.prototype.destroy);goog.exportSymbol("M.control.Measure",M.control.Measure);goog.exportProperty(M.control.Measure.prototype,"createView",M.control.Measure.prototype.createView);goog.exportProperty(M.control.Measure.prototype,"getActivationButton",M.control.Measure.prototype.getActivationButton);
goog.exportProperty(M.control.Measure.prototype,"equals",M.control.Measure.prototype.equals);goog.exportProperty(M.control.Measure.prototype,"destroy",M.control.Measure.prototype.destroy);goog.exportSymbol("M.control.Measure.NAME",M.control.Measure.NAME);goog.exportSymbol("M.control.Measure.POINTER_TOOLTIP_TEMPLATE",M.control.Measure.POINTER_TOOLTIP_TEMPLATE);goog.exportSymbol("M.control.Measure.MEASURE_TOOLTIP_TEMPLATE",M.control.Measure.MEASURE_TOOLTIP_TEMPLATE);
goog.exportSymbol("M.control.Measure.HELP_MESSAGE",M.control.Measure.HELP_MESSAGE);goog.exportSymbol("M.impl.control.MeasureClear",M.impl.control.MeasureClear);goog.exportProperty(M.impl.control.MeasureClear.prototype,"addTo",M.impl.control.MeasureClear.prototype.addTo);goog.exportProperty(M.impl.control.MeasureClear.prototype,"onClick",M.impl.control.MeasureClear.prototype.onClick);goog.exportProperty(M.impl.control.MeasureClear.prototype,"destroy",M.impl.control.MeasureClear.prototype.destroy);
goog.exportSymbol("M.control.MeasureClear",M.control.MeasureClear);goog.exportProperty(M.control.MeasureClear.prototype,"createView",M.control.MeasureClear.prototype.createView);goog.exportProperty(M.control.MeasureClear.prototype,"equals",M.control.MeasureClear.prototype.equals);goog.exportProperty(M.control.MeasureClear.prototype,"destroy",M.control.MeasureClear.prototype.destroy);goog.exportSymbol("M.control.MeasureClear.NAME",M.control.MeasureClear.NAME);
goog.exportSymbol("M.control.MeasureClear.TEMPLATE",M.control.MeasureClear.TEMPLATE);goog.exportSymbol("M.impl.control.MeasureLength",M.impl.control.MeasureLength);goog.exportProperty(M.impl.control.MeasureLength.prototype,"formatGeometry",M.impl.control.MeasureLength.prototype.formatGeometry);goog.exportProperty(M.impl.control.MeasureLength.prototype,"getTooltipCoordinate",M.impl.control.MeasureLength.prototype.getTooltipCoordinate);goog.exportSymbol("M.control.MeasureLength",M.control.MeasureLength);
goog.exportProperty(M.control.MeasureLength.prototype,"equals",M.control.MeasureLength.prototype.equals);goog.exportSymbol("M.control.MeasureLength.TEMPLATE",M.control.MeasureLength.TEMPLATE);goog.exportSymbol("M.control.MeasureLength.HELP_KEEP_MESSAGE",M.control.MeasureLength.HELP_KEEP_MESSAGE);goog.exportProperty(M.impl.control.MeasureArea.prototype,"addTo",M.impl.control.MeasureArea.prototype.addTo);goog.exportProperty(M.impl.control.MeasureArea.prototype,"activate",M.impl.control.MeasureArea.prototype.activate);
goog.exportProperty(M.impl.control.MeasureArea.prototype,"deactivate",M.impl.control.MeasureArea.prototype.deactivate);goog.exportProperty(M.impl.control.MeasureArea.prototype,"clear",M.impl.control.MeasureArea.prototype.clear);goog.exportProperty(M.impl.control.MeasureArea.prototype,"destroy",M.impl.control.MeasureArea.prototype.destroy);goog.exportProperty(M.control.MeasureArea.prototype,"createView",M.control.MeasureArea.prototype.createView);
goog.exportProperty(M.control.MeasureArea.prototype,"getActivationButton",M.control.MeasureArea.prototype.getActivationButton);goog.exportProperty(M.control.MeasureArea.prototype,"destroy",M.control.MeasureArea.prototype.destroy);goog.exportProperty(M.impl.control.MeasureLength.prototype,"addTo",M.impl.control.MeasureLength.prototype.addTo);goog.exportProperty(M.impl.control.MeasureLength.prototype,"activate",M.impl.control.MeasureLength.prototype.activate);
goog.exportProperty(M.impl.control.MeasureLength.prototype,"deactivate",M.impl.control.MeasureLength.prototype.deactivate);goog.exportProperty(M.impl.control.MeasureLength.prototype,"clear",M.impl.control.MeasureLength.prototype.clear);goog.exportProperty(M.impl.control.MeasureLength.prototype,"destroy",M.impl.control.MeasureLength.prototype.destroy);goog.exportProperty(M.control.MeasureLength.prototype,"createView",M.control.MeasureLength.prototype.createView);
goog.exportProperty(M.control.MeasureLength.prototype,"getActivationButton",M.control.MeasureLength.prototype.getActivationButton);goog.exportProperty(M.control.MeasureLength.prototype,"destroy",M.control.MeasureLength.prototype.destroy); })(window.M);
