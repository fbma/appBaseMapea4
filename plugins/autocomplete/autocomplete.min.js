(function (M) { var COMPILED=!0,goog=goog||{};goog.global=this;goog.isDef=function(a){return void 0!==a};goog.exportPath_=function(a,b,c){a=a.split(".");c=c||goog.global;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&goog.isDef(b)?c[d]=b:c=c[d]?c[d]:c[d]={}};
...
},goog.requiresTranspilation_=null,goog.lastNonModuleScriptIndex_=0,goog.onScriptLoad_=function(a,b){"complete"==a.readyState&&goog.lastNonModuleScriptIndex_==b&&goog.loadQueuedModules_();return!0},goog.writeScripts_=function(a){function b(a){if(!(a in f.written||a in f.visited)){f.visited[a]=!0;if(a in f.requires)for(var e in f.requires[a])if(!goog.isProvided_(e))if(e in f.nameToPath)b(f.nameToPath[e]);else throw Error("Undefined nameToPath for "+e);a in d||(d[a]=!0,c.push(a))}}var c=[],d={},f=goog.dependencies_;
b(a);for(a=0;a<c.length;a++){var e=c[a];goog.dependencies_.written[e]=!0}var g=goog.moduleLoaderState_;goog.moduleLoaderState_=null;for(a=0;a<c.length;a++)if(e=c[a]){var h=f.loadFlags[e]||{},k=goog.needsTranspile_(h.lang||"es3");"goog"==h.module||k?goog.importProcessedScript_(goog.basePath+e,"goog"==h.module,k):goog.importScript_(goog.basePath+e)}else throw goog.moduleLoaderState_=g,Error("Undefined script input");goog.moduleLoaderState_=g},goog.getPathFromDeps_=function(a){return a in goog.dependencies_.nameToPath?
...
goog.transpile_=function(a,b){var c=goog.global.$jscomp;c||(goog.global.$jscomp=c={});var d=c.transpile;if(!d){var f=goog.basePath+goog.TRANSPILER,e=goog.loadFileSync_(f);if(e){eval(e+"\n//# sourceURL="+f);if(goog.global.$gwtExport&&goog.global.$gwtExport.$jscomp&&!goog.global.$gwtExport.$jscomp.transpile)throw Error('The transpiler did not properly export the "transpile" method. $gwtExport: '+JSON.stringify(goog.global.$gwtExport));goog.global.$jscomp.transpile=goog.global.$gwtExport.$jscomp.transpile;
...
goog.inherits=function(a,b){function c(){}c.prototype=b.prototype;a.superClass_=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.base=function(a,c,e){for(var d=Array(arguments.length-2),f=2;f<arguments.length;f++)d[f-2]=arguments[f];return b.prototype[c].apply(a,d)}};
...
goog.createRequiresTranspilation_=function(){function a(a,b){d?c[a]=!0:b()?c[a]=!1:d=c[a]=!0}function b(a){try{return!!eval(a)}catch(e){return!1}}var c={es3:!1},d=!1;a("es5",function(){return b("[1,].length==1")});a("es6",function(){return b('(()=>{"use strict";class X{constructor(){if(new.target!=String)throw 1;this.x=42}}let q=Reflect.construct(X,[],String);if(q.x!=42||!(q instanceof String))throw 1;for(const a of[2,3]){if(a==2)continue;function f(z={a}){let a=0;return z.a}{function f(){return 0;}}return f()==3}})()')});
a("es6-impl",function(){return!0});a("es7",function(){return b("2 ** 2 == 4")});a("es8",function(){return b("async () => 1, true")});return c};goog.exportSymbol("M.plugin.Autocomplete",M.plugin.Autocomplete);goog.exportProperty(M.plugin.Autocomplete.prototype,"name",M.plugin.Autocomplete.prototype.name);goog.exportProperty(M.plugin.Autocomplete.prototype,"addTo",M.plugin.Autocomplete.prototype.addTo);goog.exportProperty(M.plugin.Autocomplete.prototype,"destroy",M.plugin.Autocomplete.prototype.destroy);goog.exportSymbol("M.plugin.Autocomplete.CLASS",M.plugin.Autocomplete.CLASS);goog.exportSymbol("M.plugin.Autocomplete.SEARCHING_CLASS",M.plugin.Autocomplete.SEARCHING_CLASS);
goog.exportSymbol("M.plugin.Autocomplete.RESULTAUTOCOMPLETE",M.plugin.Autocomplete.RESULTAUTOCOMPLETE);goog.exportSymbol("M.plugin.Autocomplete.MINIMUM",M.plugin.Autocomplete.MINIMUM);goog.exportProperty(M.plugin.Autocomplete.prototype,"equals",M.plugin.Autocomplete.prototype.equals); })(window.M);
